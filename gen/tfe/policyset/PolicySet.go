...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/tfe/policyset/internal"
)
...
func PolicySet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validatePolicySet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PolicySet) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PolicySet) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_PolicySet) MoveFromId(id *string) {
...
func (p *jsiiProxy_PolicySet) MoveToId(id *string) {
