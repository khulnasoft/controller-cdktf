...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/tfe/datatfeorganizationruntask/internal"
)
...
func DataTfeOrganizationRunTask_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataTfeOrganizationRunTask_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
