...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/tfe/teammember/internal"
)
...
func (j *jsiiProxy_TeamMember) TeamId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"teamId",
...
func (j *jsiiProxy_TeamMember) TeamIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"teamIdInput",
...
func (j *jsiiProxy_TeamMember) Username() *string {
	var returns *string
	_jsii_.Get(
		j,
		"username",
...
func (j *jsiiProxy_TeamMember) UsernameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"usernameInput",
...
func (j *jsiiProxy_TeamMember)SetTeamId(val *string) {
...
func (j *jsiiProxy_TeamMember)SetUsername(val *string) {
...
func TeamMember_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateTeamMember_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (t *jsiiProxy_TeamMember) AddMoveTarget(moveTarget *string) {
...
func (t *jsiiProxy_TeamMember) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (t *jsiiProxy_TeamMember) MoveFromId(id *string) {
...
func (t *jsiiProxy_TeamMember) MoveToId(id *string) {
