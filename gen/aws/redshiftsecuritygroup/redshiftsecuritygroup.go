...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/aws/redshiftsecuritygroup/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/redshift_security_group aws_redshift_security_group}.
...
func RedshiftSecurityGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRedshiftSecurityGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RedshiftSecurityGroup) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RedshiftSecurityGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (r *jsiiProxy_RedshiftSecurityGroup) MoveFromId(id *string) {
...
func (r *jsiiProxy_RedshiftSecurityGroup) MoveToId(id *string) {
