...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/aws/dbsecuritygroup/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/db_security_group aws_db_security_group}.
...
func DbSecurityGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDbSecurityGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DbSecurityGroup) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DbSecurityGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DbSecurityGroup) MoveFromId(id *string) {
...
func (d *jsiiProxy_DbSecurityGroup) MoveToId(id *string) {
