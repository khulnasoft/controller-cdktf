...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/aws/appflowflow/internal"
)
...
func (j *jsiiProxy_AppflowFlowSourceFlowConfigSourceConnectorPropertiesSapoDataOutputReference) Object() *string {
	var returns *string
	_jsii_.Get(
		j,
		"object",
...
func (j *jsiiProxy_AppflowFlowSourceFlowConfigSourceConnectorPropertiesSapoDataOutputReference) ObjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"objectInput",
...
func (j *jsiiProxy_AppflowFlowSourceFlowConfigSourceConnectorPropertiesSapoDataOutputReference)SetObject(val *string) {
