...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/aws/elasticachereplicationgroup/internal"
)
...
func NewElasticacheReplicationGroupClusterModeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ElasticacheReplicationGroupClusterModeOutputReference {
	...
	if err := validateNewElasticacheReplicationGroupClusterModeOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
