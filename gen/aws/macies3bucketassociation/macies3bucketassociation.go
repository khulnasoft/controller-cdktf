...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/aws/macies3bucketassociation/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/macie_s3_bucket_association aws_macie_s3_bucket_association}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/macie_s3_bucket_association aws_macie_s3_bucket_association} Resource.
...
func MacieS3BucketAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMacieS3BucketAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MacieS3BucketAssociation) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MacieS3BucketAssociation) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MacieS3BucketAssociation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_MacieS3BucketAssociation) MoveFromId(id *string) {
...
func (m *jsiiProxy_MacieS3BucketAssociation) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MacieS3BucketAssociation) MoveToId(id *string) {
...
func (m *jsiiProxy_MacieS3BucketAssociation) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MacieS3BucketAssociation) ToHclTerraform() interface{} {
	var returns interface{}
