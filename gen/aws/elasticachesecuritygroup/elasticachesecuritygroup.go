...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/aws/elasticachesecuritygroup/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/elasticache_security_group aws_elasticache_security_group}.
...
func ElasticacheSecurityGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateElasticacheSecurityGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_ElasticacheSecurityGroup) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_ElasticacheSecurityGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_ElasticacheSecurityGroup) MoveFromId(id *string) {
...
func (e *jsiiProxy_ElasticacheSecurityGroup) MoveToId(id *string) {
