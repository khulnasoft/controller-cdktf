...
import (
	...
	_init_ "github.com/khulnasoft/controller-cdktf/gen/random/jsii"

	"github.com/aws/constructs-go/constructs/v10"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
	"github.com/khulnasoft/controller-cdktf/gen/random/id/internal"
)
...
func NewId(scope constructs.Construct, id *string, config *IdConfig) Id {
	...
	if err := validateNewIdParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_Id{}
...
func Id_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateId_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_Id) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_Id) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_Id) MoveFromId(id *string) {
...
func (i *jsiiProxy_Id) MoveToId(id *string) {
