...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/cloudflare/devicepolicycertificates/internal"
)
...
// The jsii proxy struct for DevicePolicyCertificates
type jsiiProxy_DevicePolicyCertificates struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_DevicePolicyCertificates) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DevicePolicyCertificates) Connection() interface{} {
...
func (j *jsiiProxy_DevicePolicyCertificates) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_DevicePolicyCertificates) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DevicePolicyCertificates) Enabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabled",
...
func (j *jsiiProxy_DevicePolicyCertificates) EnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabledInput",
...
func (j *jsiiProxy_DevicePolicyCertificates) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DevicePolicyCertificates) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DevicePolicyCertificates) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DevicePolicyCertificates) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DevicePolicyCertificates) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DevicePolicyCertificates) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DevicePolicyCertificates) Node() constructs.Node {
...
func (j *jsiiProxy_DevicePolicyCertificates) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DevicePolicyCertificates) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_DevicePolicyCertificates) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_DevicePolicyCertificates) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DevicePolicyCertificates) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DevicePolicyCertificates) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DevicePolicyCertificates) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_DevicePolicyCertificates) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func DevicePolicyCertificates_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDevicePolicyCertificates_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func DevicePolicyCertificates_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDevicePolicyCertificates_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DevicePolicyCertificates_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDevicePolicyCertificates_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DevicePolicyCertificates) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DevicePolicyCertificates) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DevicePolicyCertificates) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DevicePolicyCertificates) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DevicePolicyCertificates) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DevicePolicyCertificates) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DevicePolicyCertificates) ToMetadata() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DevicePolicyCertificates) ToString() *string {
	var returns *string
...
func (d *jsiiProxy_DevicePolicyCertificates) ToTerraform() interface{} {
	var returns interface{}
