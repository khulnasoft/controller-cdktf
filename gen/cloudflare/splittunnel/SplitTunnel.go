...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/cloudflare/splittunnel/internal"
)
...
type jsiiProxy_SplitTunnel struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_SplitTunnel) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_SplitTunnel) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_SplitTunnel) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_SplitTunnel) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_SplitTunnel) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SplitTunnel) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SplitTunnel) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_SplitTunnel) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_SplitTunnel) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SplitTunnel) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SplitTunnel) Mode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"mode",
...
func (j *jsiiProxy_SplitTunnel) ModeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"modeInput",
...
func (j *jsiiProxy_SplitTunnel) Node() constructs.Node {
...
func (j *jsiiProxy_SplitTunnel) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_SplitTunnel) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SplitTunnel) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SplitTunnel) Tunnels() SplitTunnelTunnelsList {
	var returns SplitTunnelTunnelsList
	_jsii_.Get(
		j,
		"tunnels",
		&returns,
...
func SplitTunnel_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSplitTunnel_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SplitTunnel) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SplitTunnel) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SplitTunnel) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		s,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (s *jsiiProxy_SplitTunnel) ToString() *string {
	var returns *string
