...
type ListItemValueRedirectList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) ListItemValueRedirectOutputReference
...
// The jsii proxy struct for ListItemValueRedirectList
type jsiiProxy_ListItemValueRedirectList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_ListItemValueRedirectList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ListItemValueRedirectList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ListItemValueRedirectList) InternalValue() interface{} {
...
func (j *jsiiProxy_ListItemValueRedirectList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ListItemValueRedirectList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_ListItemValueRedirectList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (l *jsiiProxy_ListItemValueRedirectList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (l *jsiiProxy_ListItemValueRedirectList) ComputeFqn() *string {
	var returns *string
...
func (l *jsiiProxy_ListItemValueRedirectList) ToString() *string {
	var returns *string
