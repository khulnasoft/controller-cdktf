...
func DlpProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDlpProfile_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DlpProfile) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DlpProfile) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DlpProfile) MoveFromId(id *string) {
...
func (d *jsiiProxy_DlpProfile) MoveToId(id *string) {
