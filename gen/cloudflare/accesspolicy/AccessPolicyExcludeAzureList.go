...
type AccessPolicyExcludeAzureList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) AccessPolicyExcludeAzureOutputReference
...
// The jsii proxy struct for AccessPolicyExcludeAzureList
type jsiiProxy_AccessPolicyExcludeAzureList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_AccessPolicyExcludeAzureList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AccessPolicyExcludeAzureList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AccessPolicyExcludeAzureList) InternalValue() interface{} {
...
func (j *jsiiProxy_AccessPolicyExcludeAzureList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_AccessPolicyExcludeAzureList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_AccessPolicyExcludeAzureList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (a *jsiiProxy_AccessPolicyExcludeAzureList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AccessPolicyExcludeAzureList) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AccessPolicyExcludeAzureList) ToString() *string {
	var returns *string
