...
type AccessPolicyRequireGsuiteList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) AccessPolicyRequireGsuiteOutputReference
...
// The jsii proxy struct for AccessPolicyRequireGsuiteList
type jsiiProxy_AccessPolicyRequireGsuiteList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_AccessPolicyRequireGsuiteList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AccessPolicyRequireGsuiteList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AccessPolicyRequireGsuiteList) InternalValue() interface{} {
...
func (j *jsiiProxy_AccessPolicyRequireGsuiteList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_AccessPolicyRequireGsuiteList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_AccessPolicyRequireGsuiteList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (a *jsiiProxy_AccessPolicyRequireGsuiteList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AccessPolicyRequireGsuiteList) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AccessPolicyRequireGsuiteList) ToString() *string {
	var returns *string
