...
type AccessPolicyIncludeOktaList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) AccessPolicyIncludeOktaOutputReference
...
// The jsii proxy struct for AccessPolicyIncludeOktaList
type jsiiProxy_AccessPolicyIncludeOktaList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_AccessPolicyIncludeOktaList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AccessPolicyIncludeOktaList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AccessPolicyIncludeOktaList) InternalValue() interface{} {
...
func (j *jsiiProxy_AccessPolicyIncludeOktaList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_AccessPolicyIncludeOktaList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_AccessPolicyIncludeOktaList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (a *jsiiProxy_AccessPolicyIncludeOktaList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AccessPolicyIncludeOktaList) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AccessPolicyIncludeOktaList) ToString() *string {
	var returns *string
