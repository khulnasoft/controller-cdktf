...
type AccessPolicyExcludeGithubList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) AccessPolicyExcludeGithubOutputReference
...
// The jsii proxy struct for AccessPolicyExcludeGithubList
type jsiiProxy_AccessPolicyExcludeGithubList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_AccessPolicyExcludeGithubList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AccessPolicyExcludeGithubList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AccessPolicyExcludeGithubList) InternalValue() interface{} {
...
func (j *jsiiProxy_AccessPolicyExcludeGithubList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_AccessPolicyExcludeGithubList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_AccessPolicyExcludeGithubList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (a *jsiiProxy_AccessPolicyExcludeGithubList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AccessPolicyExcludeGithubList) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AccessPolicyExcludeGithubList) ToString() *string {
	var returns *string
