...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/cloudflare/workerroute/internal"
)
...
func WorkerRoute_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWorkerRoute_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WorkerRoute) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WorkerRoute) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (w *jsiiProxy_WorkerRoute) MoveFromId(id *string) {
...
func (w *jsiiProxy_WorkerRoute) MoveToId(id *string) {
