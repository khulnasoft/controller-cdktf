...
type AuthenticatedOriginPullsCertificateTimeoutsOutputReference interface {
	cdktf.ComplexObject
...
// The jsii proxy struct for AuthenticatedOriginPullsCertificateTimeoutsOutputReference
type jsiiProxy_AuthenticatedOriginPullsCertificateTimeoutsOutputReference struct {
	internal.Type__cdktfComplexObject
}

func (j *jsiiProxy_AuthenticatedOriginPullsCertificateTimeoutsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_AuthenticatedOriginPullsCertificateTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AuthenticatedOriginPullsCertificateTimeoutsOutputReference) Create() *string {
	var returns *string
	_jsii_.Get(
		j,
		"create",
...
func (j *jsiiProxy_AuthenticatedOriginPullsCertificateTimeoutsOutputReference) CreateInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createInput",
...
func (j *jsiiProxy_AuthenticatedOriginPullsCertificateTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AuthenticatedOriginPullsCertificateTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AuthenticatedOriginPullsCertificateTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_AuthenticatedOriginPullsCertificateTimeoutsOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_AuthenticatedOriginPullsCertificateTimeoutsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func (a *jsiiProxy_AuthenticatedOriginPullsCertificateTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AuthenticatedOriginPullsCertificateTimeoutsOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (a *jsiiProxy_AuthenticatedOriginPullsCertificateTimeoutsOutputReference) ResetCreate() {
	_jsii_.InvokeVoid(
		a,
		"resetCreate",
		nil, // no parameters
...
func (a *jsiiProxy_AuthenticatedOriginPullsCertificateTimeoutsOutputReference) ToString() *string {
	var returns *string
