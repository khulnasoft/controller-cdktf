...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/cloudflare/accessrule/internal"
)
...
func (j *jsiiProxy_AccessRule) Configuration() AccessRuleConfigurationOutputReference {
	var returns AccessRuleConfigurationOutputReference
	_jsii_.Get(
		j,
		"configuration",
		&returns,
...
func (j *jsiiProxy_AccessRule) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_AccessRule) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AccessRule) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AccessRule) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_AccessRule) Mode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"mode",
...
func (j *jsiiProxy_AccessRule) ModeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"modeInput",
...
func (j *jsiiProxy_AccessRule) Node() constructs.Node {
...
func (j *jsiiProxy_AccessRule) Notes() *string {
	var returns *string
	_jsii_.Get(
		j,
		"notes",
...
func (j *jsiiProxy_AccessRule) NotesInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"notesInput",
...
func (j *jsiiProxy_AccessRule) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_AccessRule) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AccessRule) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_AccessRule) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewAccessRule(scope constructs.Construct, id *string, config *AccessRuleConfig) AccessRule {
	...
	if err := validateNewAccessRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AccessRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAccessRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AccessRule) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AccessRule) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AccessRule) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_AccessRule) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_AccessRule) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_AccessRule) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_AccessRule) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_AccessRule) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_AccessRule) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_AccessRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AccessRule) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AccessRule) MoveFromId(id *string) {
...
func (a *jsiiProxy_AccessRule) MoveToId(id *string) {
...
func (a *jsiiProxy_AccessRule) OverrideLogicalId(newLogicalId *string) {
...
func (a *jsiiProxy_AccessRule) PutConfiguration(value *AccessRuleConfiguration) {
...
func (a *jsiiProxy_AccessRule) ResetNotes() {
	_jsii_.InvokeVoid(
		a,
		"resetNotes",
		nil, // no parameters
...
func (a *jsiiProxy_AccessRule) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_AccessRule) ResetZoneId() {
	_jsii_.InvokeVoid(
		a,
		"resetZoneId",
		nil, // no parameters
