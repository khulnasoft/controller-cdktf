...
func (j *jsiiProxy_TunnelConfigConfigWarpRoutingOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TunnelConfigConfigWarpRoutingOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_TunnelConfigConfigWarpRoutingOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_TunnelConfigConfigWarpRoutingOutputReference) InternalValue() *TunnelConfigConfigWarpRouting {
...
func (j *jsiiProxy_TunnelConfigConfigWarpRoutingOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (t *jsiiProxy_TunnelConfigConfigWarpRoutingOutputReference) ComputeFqn() *string {
	var returns *string
...
func (t *jsiiProxy_TunnelConfigConfigWarpRoutingOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (t *jsiiProxy_TunnelConfigConfigWarpRoutingOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (t *jsiiProxy_TunnelConfigConfigWarpRoutingOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (t *jsiiProxy_TunnelConfigConfigWarpRoutingOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (t *jsiiProxy_TunnelConfigConfigWarpRoutingOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (t *jsiiProxy_TunnelConfigConfigWarpRoutingOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (t *jsiiProxy_TunnelConfigConfigWarpRoutingOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (t *jsiiProxy_TunnelConfigConfigWarpRoutingOutputReference) ResetEnabled() {
	_jsii_.InvokeVoid(
		t,
		"resetEnabled",
		nil, // no parameters
...
func (t *jsiiProxy_TunnelConfigConfigWarpRoutingOutputReference) ToString() *string {
	var returns *string
