...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/cloudflare/totaltls/internal"
)
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.3.0/docs/resources/total_tls cloudflare_total_tls} Resource.
...
func TotalTls_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateTotalTls_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (t *jsiiProxy_TotalTls) AddMoveTarget(moveTarget *string) {
...
func (t *jsiiProxy_TotalTls) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (t *jsiiProxy_TotalTls) MoveFromId(id *string) {
...
func (t *jsiiProxy_TotalTls) MoveToId(id *string) {
