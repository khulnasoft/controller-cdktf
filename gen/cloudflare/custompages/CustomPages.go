...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/cloudflare/custompages/internal"
)
...
func (c *jsiiProxy_CustomPages) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CustomPages) MoveFromId(id *string) {
...
func (c *jsiiProxy_CustomPages) MoveToId(id *string) {
