...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/cloudflare/accessapplication/internal"
)

type AccessApplicationCorsHeadersList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) AccessApplicationCorsHeadersOutputReference
...
// The jsii proxy struct for AccessApplicationCorsHeadersList
type jsiiProxy_AccessApplicationCorsHeadersList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_AccessApplicationCorsHeadersList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AccessApplicationCorsHeadersList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AccessApplicationCorsHeadersList) InternalValue() interface{} {
...
func (j *jsiiProxy_AccessApplicationCorsHeadersList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_AccessApplicationCorsHeadersList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_AccessApplicationCorsHeadersList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (a *jsiiProxy_AccessApplicationCorsHeadersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AccessApplicationCorsHeadersList) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AccessApplicationCorsHeadersList) ToString() *string {
	var returns *string
