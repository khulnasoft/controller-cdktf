...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/cloudflare/logpushownershipchallenge/internal"
)

// Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.3.0/docs/resources/logpush_ownership_challenge cloudflare_logpush_ownership_challenge}.
...
func (j *jsiiProxy_LogpushOwnershipChallenge) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_LogpushOwnershipChallenge) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_LogpushOwnershipChallenge) OwnershipChallengeFilename() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (l *jsiiProxy_LogpushOwnershipChallenge) ResetId() {
	_jsii_.InvokeVoid(
		l,
		"resetId",
		nil, // no parameters
