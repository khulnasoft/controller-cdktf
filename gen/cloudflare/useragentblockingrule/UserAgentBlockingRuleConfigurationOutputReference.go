...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/cloudflare/useragentblockingrule/internal"
)
...
func (j *jsiiProxy_UserAgentBlockingRuleConfigurationOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_UserAgentBlockingRuleConfigurationOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_UserAgentBlockingRuleConfigurationOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_UserAgentBlockingRuleConfigurationOutputReference) Target() *string {
	var returns *string
	_jsii_.Get(
		j,
		"target",
...
func (j *jsiiProxy_UserAgentBlockingRuleConfigurationOutputReference) TargetInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"targetInput",
...
func (j *jsiiProxy_UserAgentBlockingRuleConfigurationOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_UserAgentBlockingRuleConfigurationOutputReference) Value() *string {
	var returns *string
	_jsii_.Get(
		j,
		"value",
...
func (j *jsiiProxy_UserAgentBlockingRuleConfigurationOutputReference) ValueInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"valueInput",
...
func (u *jsiiProxy_UserAgentBlockingRuleConfigurationOutputReference) ComputeFqn() *string {
	var returns *string
...
func (u *jsiiProxy_UserAgentBlockingRuleConfigurationOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (u *jsiiProxy_UserAgentBlockingRuleConfigurationOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (u *jsiiProxy_UserAgentBlockingRuleConfigurationOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (u *jsiiProxy_UserAgentBlockingRuleConfigurationOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (u *jsiiProxy_UserAgentBlockingRuleConfigurationOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (u *jsiiProxy_UserAgentBlockingRuleConfigurationOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (u *jsiiProxy_UserAgentBlockingRuleConfigurationOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (u *jsiiProxy_UserAgentBlockingRuleConfigurationOutputReference) ToString() *string {
	var returns *string
