...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/cloudflare/workerskv/internal"
)
...
func (j *jsiiProxy_WorkersKv) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_WorkersKv) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_WorkersKv) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_WorkersKv) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_WorkersKv) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_WorkersKv) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WorkersKv) NamespaceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespaceId",
...
func (j *jsiiProxy_WorkersKv) NamespaceIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespaceIdInput",
...
func (j *jsiiProxy_WorkersKv) Node() constructs.Node {
...
func (j *jsiiProxy_WorkersKv) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_WorkersKv) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_WorkersKv) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WorkersKv) Value() *string {
	var returns *string
	_jsii_.Get(
		j,
		"value",
...
func (j *jsiiProxy_WorkersKv) ValueInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"valueInput",
...
func NewWorkersKv(scope constructs.Construct, id *string, config *WorkersKvConfig) WorkersKv {
	...
	if err := validateNewWorkersKvParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func WorkersKv_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWorkersKv_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WorkersKv) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WorkersKv) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WorkersKv) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (w *jsiiProxy_WorkersKv) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (w *jsiiProxy_WorkersKv) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (w *jsiiProxy_WorkersKv) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (w *jsiiProxy_WorkersKv) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (w *jsiiProxy_WorkersKv) GetStringAttribute(terraformAttribute *string) *string {
...
func (w *jsiiProxy_WorkersKv) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (w *jsiiProxy_WorkersKv) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (w *jsiiProxy_WorkersKv) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WorkersKv) MoveFromId(id *string) {
...
func (w *jsiiProxy_WorkersKv) MoveToId(id *string) {
...
func (w *jsiiProxy_WorkersKv) OverrideLogicalId(newLogicalId *string) {
...
func (w *jsiiProxy_WorkersKv) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		w,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (w *jsiiProxy_WorkersKv) ToString() *string {
	var returns *string
