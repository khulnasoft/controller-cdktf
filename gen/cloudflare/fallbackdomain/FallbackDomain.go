...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/cloudflare/fallbackdomain/internal"
)
...
type jsiiProxy_FallbackDomain struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_FallbackDomain) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_FallbackDomain) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_FallbackDomain) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_FallbackDomain) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_FallbackDomain) Domains() FallbackDomainDomainsList {
	var returns FallbackDomainDomainsList
	_jsii_.Get(
		j,
		"domains",
		&returns,
...
func (j *jsiiProxy_FallbackDomain) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_FallbackDomain) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_FallbackDomain) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_FallbackDomain) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_FallbackDomain) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_FallbackDomain) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_FallbackDomain) Node() constructs.Node {
...
func (j *jsiiProxy_FallbackDomain) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_FallbackDomain) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewFallbackDomain(scope constructs.Construct, id *string, config *FallbackDomainConfig) FallbackDomain {
	...
	if err := validateNewFallbackDomainParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func FallbackDomain_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateFallbackDomain_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FallbackDomain) AddMoveTarget(moveTarget *string) {
...
func (f *jsiiProxy_FallbackDomain) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FallbackDomain) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (f *jsiiProxy_FallbackDomain) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (f *jsiiProxy_FallbackDomain) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (f *jsiiProxy_FallbackDomain) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (f *jsiiProxy_FallbackDomain) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (f *jsiiProxy_FallbackDomain) GetStringAttribute(terraformAttribute *string) *string {
...
func (f *jsiiProxy_FallbackDomain) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (f *jsiiProxy_FallbackDomain) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (f *jsiiProxy_FallbackDomain) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FallbackDomain) MoveFromId(id *string) {
...
func (f *jsiiProxy_FallbackDomain) MoveToId(id *string) {
...
func (f *jsiiProxy_FallbackDomain) OverrideLogicalId(newLogicalId *string) {
...
func (f *jsiiProxy_FallbackDomain) ResetId() {
	_jsii_.InvokeVoid(
		f,
		"resetId",
		nil, // no parameters
...
func (f *jsiiProxy_FallbackDomain) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		f,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (f *jsiiProxy_FallbackDomain) ToString() *string {
	var returns *string
