...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/cloudflare/accountmember/internal"
)
...
func (j *jsiiProxy_AccountMember) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_AccountMember) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AccountMember) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AccountMember) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_AccountMember) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_AccountMember) Node() constructs.Node {
...
func (j *jsiiProxy_AccountMember) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_AccountMember) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewAccountMember(scope constructs.Construct, id *string, config *AccountMemberConfig) AccountMember {
	...
	if err := validateNewAccountMemberParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AccountMember_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAccountMember_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AccountMember) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AccountMember) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AccountMember) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_AccountMember) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_AccountMember) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_AccountMember) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_AccountMember) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_AccountMember) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_AccountMember) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_AccountMember) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AccountMember) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AccountMember) MoveFromId(id *string) {
...
func (a *jsiiProxy_AccountMember) MoveToId(id *string) {
...
func (a *jsiiProxy_AccountMember) OverrideLogicalId(newLogicalId *string) {
...
func (a *jsiiProxy_AccountMember) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_AccountMember) ToString() *string {
	var returns *string
