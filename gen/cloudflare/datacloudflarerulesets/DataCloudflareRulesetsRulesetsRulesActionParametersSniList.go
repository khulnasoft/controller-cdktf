...
func (j *jsiiProxy_DataCloudflareRulesetsRulesetsRulesActionParametersSniList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataCloudflareRulesetsRulesetsRulesActionParametersSniList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataCloudflareRulesetsRulesetsRulesActionParametersSniList {
	_init_.Initialize()
...
func NewDataCloudflareRulesetsRulesetsRulesActionParametersSniList_Override(d DataCloudflareRulesetsRulesetsRulesActionParametersSniList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflareRulesetsRulesetsRulesActionParametersSniList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflareRulesetsRulesetsRulesActionParametersSniList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataCloudflareRulesetsRulesetsRulesActionParametersSniList) Resolve(_context cdktf.IResolveContext) interface{} {
