...
func (d *jsiiProxy_DataCloudflareRulesetsRulesetsRulesActionParametersServeStaleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
