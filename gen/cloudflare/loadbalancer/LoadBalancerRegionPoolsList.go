...
type LoadBalancerRegionPoolsList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) LoadBalancerRegionPoolsOutputReference
...
// The jsii proxy struct for LoadBalancerRegionPoolsList
type jsiiProxy_LoadBalancerRegionPoolsList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_LoadBalancerRegionPoolsList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_LoadBalancerRegionPoolsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LoadBalancerRegionPoolsList) InternalValue() interface{} {
...
func (j *jsiiProxy_LoadBalancerRegionPoolsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_LoadBalancerRegionPoolsList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_LoadBalancerRegionPoolsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (l *jsiiProxy_LoadBalancerRegionPoolsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LoadBalancerRegionPoolsList) ComputeFqn() *string {
	var returns *string
...
func (l *jsiiProxy_LoadBalancerRegionPoolsList) ToString() *string {
	var returns *string
