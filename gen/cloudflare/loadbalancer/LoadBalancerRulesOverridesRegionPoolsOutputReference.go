...
type LoadBalancerRulesOverridesRegionPoolsOutputReference interface {
	cdktf.ComplexObject
...
// The jsii proxy struct for LoadBalancerRulesOverridesRegionPoolsOutputReference
type jsiiProxy_LoadBalancerRulesOverridesRegionPoolsOutputReference struct {
	internal.Type__cdktfComplexObject
}

func (j *jsiiProxy_LoadBalancerRulesOverridesRegionPoolsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_LoadBalancerRulesOverridesRegionPoolsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LoadBalancerRulesOverridesRegionPoolsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_LoadBalancerRulesOverridesRegionPoolsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LoadBalancerRulesOverridesRegionPoolsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_LoadBalancerRulesOverridesRegionPoolsOutputReference) PoolIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"poolIds",
...
func (j *jsiiProxy_LoadBalancerRulesOverridesRegionPoolsOutputReference) PoolIdsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"poolIdsInput",
...
func (j *jsiiProxy_LoadBalancerRulesOverridesRegionPoolsOutputReference) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_LoadBalancerRulesOverridesRegionPoolsOutputReference) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_LoadBalancerRulesOverridesRegionPoolsOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_LoadBalancerRulesOverridesRegionPoolsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func (l *jsiiProxy_LoadBalancerRulesOverridesRegionPoolsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (l *jsiiProxy_LoadBalancerRulesOverridesRegionPoolsOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (l *jsiiProxy_LoadBalancerRulesOverridesRegionPoolsOutputReference) ToString() *string {
	var returns *string
