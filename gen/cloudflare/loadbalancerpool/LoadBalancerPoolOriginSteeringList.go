...
type LoadBalancerPoolOriginSteeringList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) LoadBalancerPoolOriginSteeringOutputReference
...
// The jsii proxy struct for LoadBalancerPoolOriginSteeringList
type jsiiProxy_LoadBalancerPoolOriginSteeringList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_LoadBalancerPoolOriginSteeringList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_LoadBalancerPoolOriginSteeringList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LoadBalancerPoolOriginSteeringList) InternalValue() interface{} {
...
func (j *jsiiProxy_LoadBalancerPoolOriginSteeringList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_LoadBalancerPoolOriginSteeringList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_LoadBalancerPoolOriginSteeringList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (l *jsiiProxy_LoadBalancerPoolOriginSteeringList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LoadBalancerPoolOriginSteeringList) ComputeFqn() *string {
	var returns *string
...
func (l *jsiiProxy_LoadBalancerPoolOriginSteeringList) ToString() *string {
	var returns *string
