...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/cloudflare/loadbalancerpool/internal"
)

type LoadBalancerPoolOriginsOutputReference interface {
	cdktf.ComplexObject
	Address() *string
...
// The jsii proxy struct for LoadBalancerPoolOriginsOutputReference
type jsiiProxy_LoadBalancerPoolOriginsOutputReference struct {
	internal.Type__cdktfComplexObject
}

func (j *jsiiProxy_LoadBalancerPoolOriginsOutputReference) Address() *string {
	var returns *string
	_jsii_.Get(
		j,
		"address",
...
func (j *jsiiProxy_LoadBalancerPoolOriginsOutputReference) AddressInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"addressInput",
...
func (j *jsiiProxy_LoadBalancerPoolOriginsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LoadBalancerPoolOriginsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_LoadBalancerPoolOriginsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LoadBalancerPoolOriginsOutputReference) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_LoadBalancerPoolOriginsOutputReference) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_LoadBalancerPoolOriginsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_LoadBalancerPoolOriginsOutputReference) WeightInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"weightInput",
...
func NewLoadBalancerPoolOriginsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) LoadBalancerPoolOriginsOutputReference {
	...
	if err := validateNewLoadBalancerPoolOriginsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LoadBalancerPoolOriginsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (l *jsiiProxy_LoadBalancerPoolOriginsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LoadBalancerPoolOriginsOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (l *jsiiProxy_LoadBalancerPoolOriginsOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (l *jsiiProxy_LoadBalancerPoolOriginsOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (l *jsiiProxy_LoadBalancerPoolOriginsOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (l *jsiiProxy_LoadBalancerPoolOriginsOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (l *jsiiProxy_LoadBalancerPoolOriginsOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (l *jsiiProxy_LoadBalancerPoolOriginsOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (l *jsiiProxy_LoadBalancerPoolOriginsOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (l *jsiiProxy_LoadBalancerPoolOriginsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LoadBalancerPoolOriginsOutputReference) ResetHeader() {
	_jsii_.InvokeVoid(
		l,
		"resetHeader",
		nil, // no parameters
...
func (l *jsiiProxy_LoadBalancerPoolOriginsOutputReference) ResetWeight() {
	_jsii_.InvokeVoid(
		l,
		"resetWeight",
		nil, // no parameters
...
func (l *jsiiProxy_LoadBalancerPoolOriginsOutputReference) ToString() *string {
	var returns *string
