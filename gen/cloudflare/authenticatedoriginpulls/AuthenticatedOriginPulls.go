...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/cloudflare/authenticatedoriginpulls/internal"
)
...
type jsiiProxy_AuthenticatedOriginPulls struct {
...
func (j *jsiiProxy_AuthenticatedOriginPulls) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AuthenticatedOriginPulls) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AuthenticatedOriginPulls) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_AuthenticatedOriginPulls) Hostname() *string {
	var returns *string
	_jsii_.Get(
		j,
		"hostname",
...
func (j *jsiiProxy_AuthenticatedOriginPulls) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AuthenticatedOriginPulls) Node() constructs.Node {
...
func (j *jsiiProxy_AuthenticatedOriginPulls) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_AuthenticatedOriginPulls) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AuthenticatedOriginPulls) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func AuthenticatedOriginPulls_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAuthenticatedOriginPulls_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AuthenticatedOriginPulls) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AuthenticatedOriginPulls) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AuthenticatedOriginPulls) MoveFromId(id *string) {
...
func (a *jsiiProxy_AuthenticatedOriginPulls) MoveToId(id *string) {
...
func (a *jsiiProxy_AuthenticatedOriginPulls) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_AuthenticatedOriginPulls) ToString() *string {
	var returns *string
