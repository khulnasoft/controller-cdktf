...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/cloudflare/ratelimit/internal"
)
...
func (j *jsiiProxy_RateLimitActionOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RateLimitActionOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_RateLimitActionOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_RateLimitActionOutputReference) Mode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"mode",
...
func (j *jsiiProxy_RateLimitActionOutputReference) ModeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"modeInput",
...
func (j *jsiiProxy_RateLimitActionOutputReference) Response() RateLimitActionResponseOutputReference {
	var returns RateLimitActionResponseOutputReference
	_jsii_.Get(
		j,
		"response",
		&returns,
...
func (j *jsiiProxy_RateLimitActionOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_RateLimitActionOutputReference) Timeout() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"timeout",
...
func (j *jsiiProxy_RateLimitActionOutputReference) TimeoutInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"timeoutInput",
...
func (r *jsiiProxy_RateLimitActionOutputReference) ComputeFqn() *string {
	var returns *string
...
func (r *jsiiProxy_RateLimitActionOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (r *jsiiProxy_RateLimitActionOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (r *jsiiProxy_RateLimitActionOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (r *jsiiProxy_RateLimitActionOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (r *jsiiProxy_RateLimitActionOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (r *jsiiProxy_RateLimitActionOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (r *jsiiProxy_RateLimitActionOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (r *jsiiProxy_RateLimitActionOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RateLimitActionOutputReference) PutResponse(value *RateLimitActionResponse) {
...
func (r *jsiiProxy_RateLimitActionOutputReference) ResetResponse() {
	_jsii_.InvokeVoid(
		r,
		"resetResponse",
		nil, // no parameters
...
func (r *jsiiProxy_RateLimitActionOutputReference) ResetTimeout() {
	_jsii_.InvokeVoid(
		r,
		"resetTimeout",
		nil, // no parameters
...
func (r *jsiiProxy_RateLimitActionOutputReference) ToString() *string {
	var returns *string
