...
type WorkerScriptR2BucketBindingList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) WorkerScriptR2BucketBindingOutputReference
...
// The jsii proxy struct for WorkerScriptR2BucketBindingList
type jsiiProxy_WorkerScriptR2BucketBindingList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_WorkerScriptR2BucketBindingList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_WorkerScriptR2BucketBindingList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_WorkerScriptR2BucketBindingList) InternalValue() interface{} {
...
func (j *jsiiProxy_WorkerScriptR2BucketBindingList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_WorkerScriptR2BucketBindingList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_WorkerScriptR2BucketBindingList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (w *jsiiProxy_WorkerScriptR2BucketBindingList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WorkerScriptR2BucketBindingList) ComputeFqn() *string {
	var returns *string
...
func (w *jsiiProxy_WorkerScriptR2BucketBindingList) ToString() *string {
	var returns *string
