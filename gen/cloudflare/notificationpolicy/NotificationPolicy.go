...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/cloudflare/notificationpolicy/internal"
)
...
func NotificationPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateNotificationPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (n *jsiiProxy_NotificationPolicy) AddMoveTarget(moveTarget *string) {
