...
type DeviceManagedNetworks interface {
	...
	PutConfig(value *DeviceManagedNetworksConfigA)
	ResetId()
...
type jsiiProxy_DeviceManagedNetworks struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_DeviceManagedNetworks) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_DeviceManagedNetworks) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_DeviceManagedNetworks) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DeviceManagedNetworks) Config() DeviceManagedNetworksConfigAOutputReference {
	var returns DeviceManagedNetworksConfigAOutputReference
	_jsii_.Get(
		j,
		"config",
		&returns,
...
func (j *jsiiProxy_DeviceManagedNetworks) ConfigInput() *DeviceManagedNetworksConfigA {
...
func (j *jsiiProxy_DeviceManagedNetworks) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DeviceManagedNetworks) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DeviceManagedNetworks) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DeviceManagedNetworks) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DeviceManagedNetworks) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DeviceManagedNetworks) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DeviceManagedNetworks) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DeviceManagedNetworks) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DeviceManagedNetworks) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_DeviceManagedNetworks) Node() constructs.Node {
...
func (j *jsiiProxy_DeviceManagedNetworks) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DeviceManagedNetworks) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DeviceManagedNetworks) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DeviceManagedNetworks) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_DeviceManagedNetworks) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
func NewDeviceManagedNetworks(scope constructs.Construct, id *string, config *DeviceManagedNetworksConfig) DeviceManagedNetworks {
	...
	if err := validateNewDeviceManagedNetworksParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DeviceManagedNetworks_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDeviceManagedNetworks_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DeviceManagedNetworks) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DeviceManagedNetworks) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DeviceManagedNetworks) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DeviceManagedNetworks) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DeviceManagedNetworks) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DeviceManagedNetworks) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DeviceManagedNetworks) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DeviceManagedNetworks) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DeviceManagedNetworks) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DeviceManagedNetworks) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DeviceManagedNetworks) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DeviceManagedNetworks) PutConfig(value *DeviceManagedNetworksConfigA) {
...
func (d *jsiiProxy_DeviceManagedNetworks) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DeviceManagedNetworks) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DeviceManagedNetworks) ToString() *string {
	var returns *string
