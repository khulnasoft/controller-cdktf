...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/cloudflare/spectrumapplication/internal"
)

type SpectrumApplicationOriginDnsOutputReference interface {
	cdktf.ComplexObject
...
// The jsii proxy struct for SpectrumApplicationOriginDnsOutputReference
type jsiiProxy_SpectrumApplicationOriginDnsOutputReference struct {
	internal.Type__cdktfComplexObject
}

func (j *jsiiProxy_SpectrumApplicationOriginDnsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_SpectrumApplicationOriginDnsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SpectrumApplicationOriginDnsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SpectrumApplicationOriginDnsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SpectrumApplicationOriginDnsOutputReference) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_SpectrumApplicationOriginDnsOutputReference) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_SpectrumApplicationOriginDnsOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_SpectrumApplicationOriginDnsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func (s *jsiiProxy_SpectrumApplicationOriginDnsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SpectrumApplicationOriginDnsOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (s *jsiiProxy_SpectrumApplicationOriginDnsOutputReference) ToString() *string {
	var returns *string
