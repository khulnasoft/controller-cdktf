...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/cloudflare/customhostnamefallbackorigin/internal"
)
...
func (c *jsiiProxy_CustomHostnameFallbackOrigin) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CustomHostnameFallbackOrigin) MoveFromId(id *string) {
...
func (c *jsiiProxy_CustomHostnameFallbackOrigin) MoveToId(id *string) {
