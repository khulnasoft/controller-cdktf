...
func ApiShield_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateApiShield_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiShield) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApiShield) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_ApiShield) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApiShield) MoveToId(id *string) {
