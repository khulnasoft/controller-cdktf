...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/cloudflare/web3hostname/internal"
)
...
type jsiiProxy_Web3Hostname struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_Web3Hostname) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_Web3Hostname) CreatedOn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdOn",
...
func (j *jsiiProxy_Web3Hostname) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_Web3Hostname) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_Web3Hostname) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_Web3Hostname) Dnslink() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dnslink",
...
func (j *jsiiProxy_Web3Hostname) DnslinkInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dnslinkInput",
...
func (j *jsiiProxy_Web3Hostname) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Web3Hostname) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Web3Hostname) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_Web3Hostname) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_Web3Hostname) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Web3Hostname) ModifiedOn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"modifiedOn",
...
func (j *jsiiProxy_Web3Hostname) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_Web3Hostname) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_Web3Hostname) Node() constructs.Node {
...
func (j *jsiiProxy_Web3Hostname) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_Web3Hostname) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_Web3Hostname) Target() *string {
	var returns *string
	_jsii_.Get(
		j,
		"target",
...
func (j *jsiiProxy_Web3Hostname) TargetInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"targetInput",
...
func (j *jsiiProxy_Web3Hostname) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Web3Hostname) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Web3Hostname) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_Web3Hostname) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewWeb3Hostname(scope constructs.Construct, id *string, config *Web3HostnameConfig) Web3Hostname {
	...
	if err := validateNewWeb3HostnameParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func Web3Hostname_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWeb3Hostname_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func Web3Hostname_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-cloudflare.web3Hostname.Web3Hostname",
...
func (w *jsiiProxy_Web3Hostname) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_Web3Hostname) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_Web3Hostname) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (w *jsiiProxy_Web3Hostname) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (w *jsiiProxy_Web3Hostname) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (w *jsiiProxy_Web3Hostname) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (w *jsiiProxy_Web3Hostname) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (w *jsiiProxy_Web3Hostname) GetStringAttribute(terraformAttribute *string) *string {
...
func (w *jsiiProxy_Web3Hostname) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (w *jsiiProxy_Web3Hostname) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_Web3Hostname) OverrideLogicalId(newLogicalId *string) {
...
func (w *jsiiProxy_Web3Hostname) ResetDescription() {
	_jsii_.InvokeVoid(
		w,
		"resetDescription",
		nil, // no parameters
...
func (w *jsiiProxy_Web3Hostname) ResetDnslink() {
	_jsii_.InvokeVoid(
		w,
		"resetDnslink",
		nil, // no parameters
...
func (w *jsiiProxy_Web3Hostname) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		w,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (w *jsiiProxy_Web3Hostname) ToString() *string {
	var returns *string
