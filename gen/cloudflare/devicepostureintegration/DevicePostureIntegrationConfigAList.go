...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/cloudflare/devicepostureintegration/internal"
)

type DevicePostureIntegrationConfigAList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) DevicePostureIntegrationConfigAOutputReference
...
// The jsii proxy struct for DevicePostureIntegrationConfigAList
type jsiiProxy_DevicePostureIntegrationConfigAList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_DevicePostureIntegrationConfigAList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_DevicePostureIntegrationConfigAList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DevicePostureIntegrationConfigAList) InternalValue() interface{} {
...
func (j *jsiiProxy_DevicePostureIntegrationConfigAList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DevicePostureIntegrationConfigAList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_DevicePostureIntegrationConfigAList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (d *jsiiProxy_DevicePostureIntegrationConfigAList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DevicePostureIntegrationConfigAList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DevicePostureIntegrationConfigAList) ToString() *string {
	var returns *string
