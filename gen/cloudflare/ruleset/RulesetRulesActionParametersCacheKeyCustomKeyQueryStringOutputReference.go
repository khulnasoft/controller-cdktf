...
type RulesetRulesActionParametersCacheKeyCustomKeyQueryStringOutputReference interface {
	cdktf.ComplexObject
...
// The jsii proxy struct for RulesetRulesActionParametersCacheKeyCustomKeyQueryStringOutputReference
type jsiiProxy_RulesetRulesActionParametersCacheKeyCustomKeyQueryStringOutputReference struct {
...
func (j *jsiiProxy_RulesetRulesActionParametersCacheKeyCustomKeyQueryStringOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RulesetRulesActionParametersCacheKeyCustomKeyQueryStringOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_RulesetRulesActionParametersCacheKeyCustomKeyQueryStringOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_RulesetRulesActionParametersCacheKeyCustomKeyQueryStringOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_RulesetRulesActionParametersCacheKeyCustomKeyQueryStringOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func (r *jsiiProxy_RulesetRulesActionParametersCacheKeyCustomKeyQueryStringOutputReference) ComputeFqn() *string {
	var returns *string
...
func (r *jsiiProxy_RulesetRulesActionParametersCacheKeyCustomKeyQueryStringOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RulesetRulesActionParametersCacheKeyCustomKeyQueryStringOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (r *jsiiProxy_RulesetRulesActionParametersCacheKeyCustomKeyQueryStringOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (r *jsiiProxy_RulesetRulesActionParametersCacheKeyCustomKeyQueryStringOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (r *jsiiProxy_RulesetRulesActionParametersCacheKeyCustomKeyQueryStringOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (r *jsiiProxy_RulesetRulesActionParametersCacheKeyCustomKeyQueryStringOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (r *jsiiProxy_RulesetRulesActionParametersCacheKeyCustomKeyQueryStringOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (r *jsiiProxy_RulesetRulesActionParametersCacheKeyCustomKeyQueryStringOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (r *jsiiProxy_RulesetRulesActionParametersCacheKeyCustomKeyQueryStringOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (r *jsiiProxy_RulesetRulesActionParametersCacheKeyCustomKeyQueryStringOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RulesetRulesActionParametersCacheKeyCustomKeyQueryStringOutputReference) ResetInclude() {
	_jsii_.InvokeVoid(
		r,
		"resetInclude",
		nil, // no parameters
...
func (r *jsiiProxy_RulesetRulesActionParametersCacheKeyCustomKeyQueryStringOutputReference) ToString() *string {
	var returns *string
