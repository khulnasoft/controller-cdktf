...
func (d *jsiiProxy_DataKubernetesPodSpecInitContainerEnvValueFromResourceFieldRefList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
