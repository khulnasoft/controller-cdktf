...
func (d *jsiiProxy_DataKubernetesPodSpecInitContainerEnvValueFromConfigMapKeyRefList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
