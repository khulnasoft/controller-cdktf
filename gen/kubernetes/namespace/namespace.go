...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/namespace kubernetes_namespace}.
type Namespace interface {
	...
	MetadataInput() *NamespaceMetadata
	// The tree node.
	...
	PutMetadata(value *NamespaceMetadata)
	PutTimeouts(value *NamespaceTimeouts)
	ResetId()
...
func (j *jsiiProxy_Namespace) Metadata() NamespaceMetadataOutputReference {
	var returns NamespaceMetadataOutputReference
	_jsii_.Get(
		j,
		"metadata",
		&returns,
...
func (j *jsiiProxy_Namespace) MetadataInput() *NamespaceMetadata {
...
func (j *jsiiProxy_Namespace) Timeouts() NamespaceTimeoutsOutputReference {
	var returns NamespaceTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func Namespace_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (n *jsiiProxy_Namespace) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (n *jsiiProxy_Namespace) PutMetadata(value *NamespaceMetadata) {
...
func (n *jsiiProxy_Namespace) PutTimeouts(value *NamespaceTimeouts) {
...
func (n *jsiiProxy_Namespace) ResetTimeouts() {
	_jsii_.InvokeVoid(
		n,
		"resetTimeouts",
		nil, // no parameters
