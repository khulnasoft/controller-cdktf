...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/cloudassetfolderfeed/internal"
)
...
func CloudAssetFolderFeed_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateCloudAssetFolderFeed_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudAssetFolderFeed) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudAssetFolderFeed) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CloudAssetFolderFeed) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CloudAssetFolderFeed) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudAssetFolderFeed) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CloudAssetFolderFeed) MoveToId(id *string) {
...
func (c *jsiiProxy_CloudAssetFolderFeed) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CloudAssetFolderFeed) ToHclTerraform() interface{} {
	var returns interface{}
