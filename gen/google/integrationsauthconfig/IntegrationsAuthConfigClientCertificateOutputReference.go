...
func (i *jsiiProxy_IntegrationsAuthConfigClientCertificateOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IntegrationsAuthConfigClientCertificateOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
