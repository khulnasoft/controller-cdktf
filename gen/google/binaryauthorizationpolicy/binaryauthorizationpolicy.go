...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/binaryauthorizationpolicy/internal"
)
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/binary_authorization_policy google_binary_authorization_policy} Resource.
...
func (b *jsiiProxy_BinaryAuthorizationPolicy) AddMoveTarget(moveTarget *string) {
...
func (b *jsiiProxy_BinaryAuthorizationPolicy) MoveFromId(id *string) {
...
func (b *jsiiProxy_BinaryAuthorizationPolicy) MoveToId(id *string) {
