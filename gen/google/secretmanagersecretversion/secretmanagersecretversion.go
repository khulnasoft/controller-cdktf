...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/secretmanagersecretversion/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/secret_manager_secret_version google_secret_manager_secret_version}.
...
type jsiiProxy_SecretManagerSecretVersion struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_SecretManagerSecretVersion) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_SecretManagerSecretVersion) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_SecretManagerSecretVersion) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_SecretManagerSecretVersion) DestroyTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"destroyTime",
...
func (j *jsiiProxy_SecretManagerSecretVersion) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SecretManagerSecretVersion) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SecretManagerSecretVersion) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_SecretManagerSecretVersion) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_SecretManagerSecretVersion) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SecretManagerSecretVersion) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SecretManagerSecretVersion) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_SecretManagerSecretVersion) Node() constructs.Node {
...
func (j *jsiiProxy_SecretManagerSecretVersion) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_SecretManagerSecretVersion) Secret() *string {
	var returns *string
	_jsii_.Get(
		j,
		"secret",
...
func (j *jsiiProxy_SecretManagerSecretVersion) SecretData() *string {
	var returns *string
	_jsii_.Get(
		j,
		"secretData",
...
func (j *jsiiProxy_SecretManagerSecretVersion) SecretDataInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"secretDataInput",
...
func (j *jsiiProxy_SecretManagerSecretVersion) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SecretManagerSecretVersion) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SecretManagerSecretVersion) Timeouts() SecretManagerSecretVersionTimeoutsOutputReference {
	var returns SecretManagerSecretVersionTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/secret_manager_secret_version google_secret_manager_secret_version} Resource.
func NewSecretManagerSecretVersion(scope constructs.Construct, id *string, config *SecretManagerSecretVersionConfig) SecretManagerSecretVersion {
	...
	if err := validateNewSecretManagerSecretVersionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func SecretManagerSecretVersion_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSecretManagerSecretVersion_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func SecretManagerSecretVersion_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.secretManagerSecretVersion.SecretManagerSecretVersion",
...
func (s *jsiiProxy_SecretManagerSecretVersion) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SecretManagerSecretVersion) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SecretManagerSecretVersion) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_SecretManagerSecretVersion) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (s *jsiiProxy_SecretManagerSecretVersion) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (s *jsiiProxy_SecretManagerSecretVersion) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_SecretManagerSecretVersion) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_SecretManagerSecretVersion) GetStringAttribute(terraformAttribute *string) *string {
...
func (s *jsiiProxy_SecretManagerSecretVersion) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_SecretManagerSecretVersion) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SecretManagerSecretVersion) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SecretManagerSecretVersion) MoveFromId(id *string) {
...
func (s *jsiiProxy_SecretManagerSecretVersion) MoveToId(id *string) {
...
func (s *jsiiProxy_SecretManagerSecretVersion) OverrideLogicalId(newLogicalId *string) {
...
func (s *jsiiProxy_SecretManagerSecretVersion) PutTimeouts(value *SecretManagerSecretVersionTimeouts) {
...
func (s *jsiiProxy_SecretManagerSecretVersion) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SecretManagerSecretVersion) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		s,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (s *jsiiProxy_SecretManagerSecretVersion) ResetTimeouts() {
	_jsii_.InvokeVoid(
		s,
		"resetTimeouts",
		nil, // no parameters
...
func (s *jsiiProxy_SecretManagerSecretVersion) ToString() *string {
	var returns *string
