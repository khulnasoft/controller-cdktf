...
// The jsii proxy struct for StorageBucketAutoclassOutputReference
type jsiiProxy_StorageBucketAutoclassOutputReference struct {
...
func (j *jsiiProxy_StorageBucketAutoclassOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_StorageBucketAutoclassOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_StorageBucketAutoclassOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_StorageBucketAutoclassOutputReference) InternalValue() *StorageBucketAutoclass {
...
func (j *jsiiProxy_StorageBucketAutoclassOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_StorageBucketAutoclassOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewStorageBucketAutoclassOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) StorageBucketAutoclassOutputReference {
	...
	if err := validateNewStorageBucketAutoclassOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_StorageBucketAutoclassOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_StorageBucketAutoclassOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageBucketAutoclassOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_StorageBucketAutoclassOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (s *jsiiProxy_StorageBucketAutoclassOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (s *jsiiProxy_StorageBucketAutoclassOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_StorageBucketAutoclassOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_StorageBucketAutoclassOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (s *jsiiProxy_StorageBucketAutoclassOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_StorageBucketAutoclassOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (s *jsiiProxy_StorageBucketAutoclassOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageBucketAutoclassOutputReference) ToString() *string {
	var returns *string
