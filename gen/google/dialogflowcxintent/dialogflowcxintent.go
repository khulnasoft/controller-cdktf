...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/dialogflowcxintent/internal"
)
...
func (j *jsiiProxy_DialogflowCxIntent) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_DialogflowCxIntent) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/dialogflow_cx_intent google_dialogflow_cx_intent} Resource.
...
func DialogflowCxIntent_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDialogflowCxIntent_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DialogflowCxIntent) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DialogflowCxIntent) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DialogflowCxIntent) MoveFromId(id *string) {
...
func (d *jsiiProxy_DialogflowCxIntent) MoveToId(id *string) {
