...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/dataproc_cluster google_dataproc_cluster}.
...
func (j *jsiiProxy_DataprocCluster) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_DataprocCluster) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/dataproc_cluster google_dataproc_cluster} Resource.
...
func DataprocCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateDataprocCluster_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataprocCluster) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DataprocCluster) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DataprocCluster) MoveFromId(id *string) {
...
func (d *jsiiProxy_DataprocCluster) MoveToId(id *string) {
