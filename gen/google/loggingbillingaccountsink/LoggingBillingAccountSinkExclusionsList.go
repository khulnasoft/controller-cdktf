...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/loggingbillingaccountsink/internal"
)
...
func (l *jsiiProxy_LoggingBillingAccountSinkExclusionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
