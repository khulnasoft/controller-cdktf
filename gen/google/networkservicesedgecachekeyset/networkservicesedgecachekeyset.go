...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/networkservicesedgecachekeyset/internal"
)
...
func (j *jsiiProxy_NetworkServicesEdgeCacheKeyset) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_NetworkServicesEdgeCacheKeyset) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_NetworkServicesEdgeCacheKeyset) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_NetworkServicesEdgeCacheKeyset) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_NetworkServicesEdgeCacheKeyset) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_NetworkServicesEdgeCacheKeyset) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_NetworkServicesEdgeCacheKeyset) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_NetworkServicesEdgeCacheKeyset) Labels() *map[string]*string {
...
func (j *jsiiProxy_NetworkServicesEdgeCacheKeyset) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_NetworkServicesEdgeCacheKeyset) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_NetworkServicesEdgeCacheKeyset) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_NetworkServicesEdgeCacheKeyset) Node() constructs.Node {
...
func (j *jsiiProxy_NetworkServicesEdgeCacheKeyset) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_NetworkServicesEdgeCacheKeyset) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_NetworkServicesEdgeCacheKeyset) PublicKey() NetworkServicesEdgeCacheKeysetPublicKeyList {
	var returns NetworkServicesEdgeCacheKeysetPublicKeyList
	_jsii_.Get(
		j,
		"publicKey",
		&returns,
...
func (j *jsiiProxy_NetworkServicesEdgeCacheKeyset) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetworkServicesEdgeCacheKeyset) Timeouts() NetworkServicesEdgeCacheKeysetTimeoutsOutputReference {
	var returns NetworkServicesEdgeCacheKeysetTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/network_services_edge_cache_keyset google_network_services_edge_cache_keyset} Resource.
func NewNetworkServicesEdgeCacheKeyset(scope constructs.Construct, id *string, config *NetworkServicesEdgeCacheKeysetConfig) NetworkServicesEdgeCacheKeyset {
	...
	if err := validateNewNetworkServicesEdgeCacheKeysetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func NetworkServicesEdgeCacheKeyset_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.networkServicesEdgeCacheKeyset.NetworkServicesEdgeCacheKeyset",
...
func (n *jsiiProxy_NetworkServicesEdgeCacheKeyset) AddMoveTarget(moveTarget *string) {
...
func (n *jsiiProxy_NetworkServicesEdgeCacheKeyset) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (n *jsiiProxy_NetworkServicesEdgeCacheKeyset) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (n *jsiiProxy_NetworkServicesEdgeCacheKeyset) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (n *jsiiProxy_NetworkServicesEdgeCacheKeyset) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (n *jsiiProxy_NetworkServicesEdgeCacheKeyset) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (n *jsiiProxy_NetworkServicesEdgeCacheKeyset) GetStringAttribute(terraformAttribute *string) *string {
...
func (n *jsiiProxy_NetworkServicesEdgeCacheKeyset) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (n *jsiiProxy_NetworkServicesEdgeCacheKeyset) MoveFromId(id *string) {
...
func (n *jsiiProxy_NetworkServicesEdgeCacheKeyset) MoveToId(id *string) {
...
func (n *jsiiProxy_NetworkServicesEdgeCacheKeyset) OverrideLogicalId(newLogicalId *string) {
...
func (n *jsiiProxy_NetworkServicesEdgeCacheKeyset) PutTimeouts(value *NetworkServicesEdgeCacheKeysetTimeouts) {
...
func (n *jsiiProxy_NetworkServicesEdgeCacheKeyset) ResetId() {
	_jsii_.InvokeVoid(
		n,
		"resetId",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkServicesEdgeCacheKeyset) ResetLabels() {
	_jsii_.InvokeVoid(
		n,
		"resetLabels",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkServicesEdgeCacheKeyset) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		n,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkServicesEdgeCacheKeyset) ResetProject() {
	_jsii_.InvokeVoid(
		n,
		"resetProject",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkServicesEdgeCacheKeyset) ToString() *string {
	var returns *string
