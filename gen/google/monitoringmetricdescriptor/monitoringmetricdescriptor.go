...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/monitoringmetricdescriptor/internal"
)
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/monitoring_metric_descriptor google_monitoring_metric_descriptor} Resource.
...
func (m *jsiiProxy_MonitoringMetricDescriptor) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MonitoringMetricDescriptor) MoveFromId(id *string) {
...
func (m *jsiiProxy_MonitoringMetricDescriptor) MoveToId(id *string) {
