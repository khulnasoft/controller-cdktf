...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/certificatemanagercertificate/internal"
)
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/certificate_manager_certificate google_certificate_manager_certificate} Resource.
...
func CertificateManagerCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CertificateManagerCertificate) ImportFrom(id *string, provider cdktf.TerraformProvider) {
