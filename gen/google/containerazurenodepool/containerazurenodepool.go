...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/containerazurenodepool/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/container_azure_node_pool google_container_azure_node_pool}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/container_azure_node_pool google_container_azure_node_pool} Resource.
...
func (c *jsiiProxy_ContainerAzureNodePool) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ContainerAzureNodePool) MoveFromId(id *string) {
...
func (c *jsiiProxy_ContainerAzureNodePool) MoveToId(id *string) {
