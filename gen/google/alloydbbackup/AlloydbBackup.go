...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/alloydbbackup/internal"
)
...
func (j *jsiiProxy_AlloydbBackup) BackupIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"backupIdInput",
...
func (j *jsiiProxy_AlloydbBackup) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_AlloydbBackup) ClusterName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clusterName",
...
func (j *jsiiProxy_AlloydbBackup) ClusterNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clusterNameInput",
...
func (j *jsiiProxy_AlloydbBackup) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_AlloydbBackup) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_AlloydbBackup) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_AlloydbBackup) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_AlloydbBackup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AlloydbBackup) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AlloydbBackup) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_AlloydbBackup) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_AlloydbBackup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_AlloydbBackup) Labels() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labels",
...
func (j *jsiiProxy_AlloydbBackup) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_AlloydbBackup) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AlloydbBackup) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_AlloydbBackup) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_AlloydbBackup) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_AlloydbBackup) Node() constructs.Node {
...
func (j *jsiiProxy_AlloydbBackup) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_AlloydbBackup) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_AlloydbBackup) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_AlloydbBackup) Reconciling() cdktf.IResolvable {
...
func (j *jsiiProxy_AlloydbBackup) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_AlloydbBackup) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AlloydbBackup) Timeouts() AlloydbBackupTimeoutsOutputReference {
	var returns AlloydbBackupTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_AlloydbBackup) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/alloydb_backup google_alloydb_backup} Resource.
func NewAlloydbBackup(scope constructs.Construct, id *string, config *AlloydbBackupConfig) AlloydbBackup {
	_init_.Initialize()

	if err := validateNewAlloydbBackupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AlloydbBackup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateAlloydbBackup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AlloydbBackup) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AlloydbBackup) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AlloydbBackup) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_AlloydbBackup) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_AlloydbBackup) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_AlloydbBackup) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_AlloydbBackup) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_AlloydbBackup) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_AlloydbBackup) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_AlloydbBackup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AlloydbBackup) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AlloydbBackup) MoveFromId(id *string) {
...
func (a *jsiiProxy_AlloydbBackup) MoveToId(id *string) {
...
func (a *jsiiProxy_AlloydbBackup) OverrideLogicalId(newLogicalId *string) {
...
func (a *jsiiProxy_AlloydbBackup) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_AlloydbBackup) ResetLabels() {
	_jsii_.InvokeVoid(
		a,
		"resetLabels",
		nil, // no parameters
...
func (a *jsiiProxy_AlloydbBackup) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_AlloydbBackup) ResetProject() {
	_jsii_.InvokeVoid(
		a,
		"resetProject",
		nil, // no parameters
...
func (a *jsiiProxy_AlloydbBackup) ResetTimeouts() {
	_jsii_.InvokeVoid(
		a,
		"resetTimeouts",
		nil, // no parameters
...
func (a *jsiiProxy_AlloydbBackup) ToString() *string {
	var returns *string
