...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/datagooglecloudquotasquotainfos/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/data-sources/cloud_quotas_quota_infos google_cloud_quotas_quota_infos}.
...
func (j *jsiiProxy_DataGoogleCloudQuotasQuotaInfos) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleCloudQuotasQuotaInfos) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleCloudQuotasQuotaInfos) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleCloudQuotasQuotaInfos) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleCloudQuotasQuotaInfos) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleCloudQuotasQuotaInfos) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleCloudQuotasQuotaInfos) Parent() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parent",
...
func (j *jsiiProxy_DataGoogleCloudQuotasQuotaInfos) ParentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parentInput",
...
func (j *jsiiProxy_DataGoogleCloudQuotasQuotaInfos) QuotaInfos() DataGoogleCloudQuotasQuotaInfosQuotaInfosList {
	var returns DataGoogleCloudQuotasQuotaInfosQuotaInfosList
	_jsii_.Get(
		j,
		"quotaInfos",
		&returns,
...
func (j *jsiiProxy_DataGoogleCloudQuotasQuotaInfos) Service() *string {
	var returns *string
	_jsii_.Get(
		j,
		"service",
...
func (j *jsiiProxy_DataGoogleCloudQuotasQuotaInfos) ServiceInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceInput",
...
func (j *jsiiProxy_DataGoogleCloudQuotasQuotaInfos) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/data-sources/cloud_quotas_quota_infos google_cloud_quotas_quota_infos} Data Source.
func NewDataGoogleCloudQuotasQuotaInfos(scope constructs.Construct, id *string, config *DataGoogleCloudQuotasQuotaInfosConfig) DataGoogleCloudQuotasQuotaInfos {
	...
	if err := validateNewDataGoogleCloudQuotasQuotaInfosParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataGoogleCloudQuotasQuotaInfos) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleCloudQuotasQuotaInfos) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleCloudQuotasQuotaInfos) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleCloudQuotasQuotaInfos) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleCloudQuotasQuotaInfos) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleCloudQuotasQuotaInfos) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleCloudQuotasQuotaInfos) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleCloudQuotasQuotaInfos) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleCloudQuotasQuotaInfos) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleCloudQuotasQuotaInfos) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleCloudQuotasQuotaInfos) ToString() *string {
	var returns *string
