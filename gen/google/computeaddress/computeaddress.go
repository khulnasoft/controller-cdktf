...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/computeaddress/internal"
)
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/compute_address google_compute_address} Resource.
...
func ComputeAddress_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateComputeAddress_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ComputeAddress) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ComputeAddress) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ComputeAddress) MoveFromId(id *string) {
...
func (c *jsiiProxy_ComputeAddress) MoveToId(id *string) {
