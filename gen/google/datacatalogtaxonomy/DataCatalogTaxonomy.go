...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/datacatalogtaxonomy/internal"
)
...
type DataCatalogTaxonomy interface {
	...
	PutTimeouts(value *DataCatalogTaxonomyTimeouts)
...
func (j *jsiiProxy_DataCatalogTaxonomy) ActivatedPolicyTypesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataCatalogTaxonomy) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataCatalogTaxonomy) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_DataCatalogTaxonomy) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_DataCatalogTaxonomy) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_DataCatalogTaxonomy) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_DataCatalogTaxonomy) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataCatalogTaxonomy) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataCatalogTaxonomy) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataCatalogTaxonomy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataCatalogTaxonomy) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataCatalogTaxonomy) Node() constructs.Node {
...
func (j *jsiiProxy_DataCatalogTaxonomy) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataCatalogTaxonomy) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataCatalogTaxonomy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataCatalogTaxonomy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataCatalogTaxonomy) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataCatalogTaxonomy) Timeouts() DataCatalogTaxonomyTimeoutsOutputReference {
	var returns DataCatalogTaxonomyTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/data_catalog_taxonomy google_data_catalog_taxonomy} Resource.
func NewDataCatalogTaxonomy(scope constructs.Construct, id *string, config *DataCatalogTaxonomyConfig) DataCatalogTaxonomy {
	_init_.Initialize()

	if err := validateNewDataCatalogTaxonomyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataCatalogTaxonomy) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DataCatalogTaxonomy) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataCatalogTaxonomy) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataCatalogTaxonomy) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataCatalogTaxonomy) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataCatalogTaxonomy) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataCatalogTaxonomy) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataCatalogTaxonomy) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataCatalogTaxonomy) MoveFromId(id *string) {
...
func (d *jsiiProxy_DataCatalogTaxonomy) MoveToId(id *string) {
...
func (d *jsiiProxy_DataCatalogTaxonomy) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataCatalogTaxonomy) PutTimeouts(value *DataCatalogTaxonomyTimeouts) {
...
func (d *jsiiProxy_DataCatalogTaxonomy) ResetActivatedPolicyTypes() {
	_jsii_.InvokeVoid(
		d,
		"resetActivatedPolicyTypes",
		nil, // no parameters
...
func (d *jsiiProxy_DataCatalogTaxonomy) ResetDescription() {
	_jsii_.InvokeVoid(
		d,
		"resetDescription",
		nil, // no parameters
...
func (d *jsiiProxy_DataCatalogTaxonomy) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataCatalogTaxonomy) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataCatalogTaxonomy) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataCatalogTaxonomy) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataCatalogTaxonomy) ResetTimeouts() {
	_jsii_.InvokeVoid(
		d,
		"resetTimeouts",
		nil, // no parameters
...
func (d *jsiiProxy_DataCatalogTaxonomy) ToString() *string {
	var returns *string
