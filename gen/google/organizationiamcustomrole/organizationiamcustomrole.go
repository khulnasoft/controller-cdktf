...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/organizationiamcustomrole/internal"
)
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/organization_iam_custom_role google_organization_iam_custom_role} Resource.
...
func (o *jsiiProxy_OrganizationIamCustomRole) AddMoveTarget(moveTarget *string) {
...
func (o *jsiiProxy_OrganizationIamCustomRole) MoveFromId(id *string) {
...
func (o *jsiiProxy_OrganizationIamCustomRole) MoveToId(id *string) {
