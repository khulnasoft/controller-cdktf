...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/datagooglebigtabletableiampolicy/internal"
)
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/data-sources/bigtable_table_iam_policy google_bigtable_table_iam_policy} Data Source.
func NewDataGoogleBigtableTableIamPolicy(scope constructs.Construct, id *string, config *DataGoogleBigtableTableIamPolicyConfig) DataGoogleBigtableTableIamPolicy {
	...
	_jsii_.Create(
		"@cdktf/provider-google.dataGoogleBigtableTableIamPolicy.DataGoogleBigtableTableIamPolicy",
