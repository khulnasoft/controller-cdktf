...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/appengineservicesplittraffic/internal"
)
...
func (a *jsiiProxy_AppEngineServiceSplitTraffic) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AppEngineServiceSplitTraffic) MoveToId(id *string) {
