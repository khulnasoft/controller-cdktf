...
func (j *jsiiProxy_ContainerClusterFleetOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ContainerClusterFleetOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ContainerClusterFleetOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ContainerClusterFleetOutputReference) InternalValue() *ContainerClusterFleet {
...
func (j *jsiiProxy_ContainerClusterFleetOutputReference) Membership() *string {
	var returns *string
	_jsii_.Get(
		j,
		"membership",
...
func (j *jsiiProxy_ContainerClusterFleetOutputReference) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_ContainerClusterFleetOutputReference) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_ContainerClusterFleetOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (c *jsiiProxy_ContainerClusterFleetOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_ContainerClusterFleetOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (c *jsiiProxy_ContainerClusterFleetOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (c *jsiiProxy_ContainerClusterFleetOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (c *jsiiProxy_ContainerClusterFleetOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (c *jsiiProxy_ContainerClusterFleetOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (c *jsiiProxy_ContainerClusterFleetOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (c *jsiiProxy_ContainerClusterFleetOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (c *jsiiProxy_ContainerClusterFleetOutputReference) ToString() *string {
	var returns *string
