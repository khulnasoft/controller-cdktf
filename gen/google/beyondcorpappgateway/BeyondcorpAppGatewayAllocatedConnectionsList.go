...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/beyondcorpappgateway/internal"
)
...
func (b *jsiiProxy_BeyondcorpAppGatewayAllocatedConnectionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
