...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/compute_url_map google_compute_url_map}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/compute_url_map google_compute_url_map} Resource.
...
func ComputeUrlMap_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateComputeUrlMap_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ComputeUrlMap) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ComputeUrlMap) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ComputeUrlMap) MoveFromId(id *string) {
...
func (c *jsiiProxy_ComputeUrlMap) MoveToId(id *string) {
