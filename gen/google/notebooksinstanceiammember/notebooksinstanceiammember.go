...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/notebooksinstanceiammember/internal"
)
...
func (j *jsiiProxy_NotebooksInstanceIamMember) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/notebooks_instance_iam_member google_notebooks_instance_iam_member} Resource.
...
func (j *jsiiProxy_NotebooksInstanceIamMember)SetCount(val interface{}) {
...
func (n *jsiiProxy_NotebooksInstanceIamMember) HasResourceMove() interface{} {
	var returns interface{}
...
func (n *jsiiProxy_NotebooksInstanceIamMember) MoveTo(moveTarget *string, index interface{}) {
...
func (n *jsiiProxy_NotebooksInstanceIamMember) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (n *jsiiProxy_NotebooksInstanceIamMember) ToHclTerraform() interface{} {
	var returns interface{}
