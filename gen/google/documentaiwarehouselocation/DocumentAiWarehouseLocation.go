...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/document_ai_warehouse_location google_document_ai_warehouse_location}.
type DocumentAiWarehouseLocation interface {
	...
	PutTimeouts(value *DocumentAiWarehouseLocationTimeouts)
...
func (j *jsiiProxy_DocumentAiWarehouseLocation) AccessControlModeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DocumentAiWarehouseLocation) DatabaseType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"databaseType",
...
func (j *jsiiProxy_DocumentAiWarehouseLocation) DatabaseTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"databaseTypeInput",
...
func (j *jsiiProxy_DocumentAiWarehouseLocation) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DocumentAiWarehouseLocation) DocumentCreatorDefaultRole() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DocumentAiWarehouseLocation) DocumentCreatorDefaultRoleInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DocumentAiWarehouseLocation) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DocumentAiWarehouseLocation) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DocumentAiWarehouseLocation) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DocumentAiWarehouseLocation) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DocumentAiWarehouseLocation) KmsKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKey",
...
func (j *jsiiProxy_DocumentAiWarehouseLocation) KmsKeyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyInput",
...
func (j *jsiiProxy_DocumentAiWarehouseLocation) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_DocumentAiWarehouseLocation) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_DocumentAiWarehouseLocation) Node() constructs.Node {
...
func (j *jsiiProxy_DocumentAiWarehouseLocation) ProjectNumber() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectNumber",
...
func (j *jsiiProxy_DocumentAiWarehouseLocation) ProjectNumberInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectNumberInput",
...
func (j *jsiiProxy_DocumentAiWarehouseLocation) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DocumentAiWarehouseLocation) Timeouts() DocumentAiWarehouseLocationTimeoutsOutputReference {
	var returns DocumentAiWarehouseLocationTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/document_ai_warehouse_location google_document_ai_warehouse_location} Resource.
func NewDocumentAiWarehouseLocation(scope constructs.Construct, id *string, config *DocumentAiWarehouseLocationConfig) DocumentAiWarehouseLocation {
	...
	if err := validateNewDocumentAiWarehouseLocationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DocumentAiWarehouseLocation) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DocumentAiWarehouseLocation) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DocumentAiWarehouseLocation) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DocumentAiWarehouseLocation) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DocumentAiWarehouseLocation) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DocumentAiWarehouseLocation) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DocumentAiWarehouseLocation) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DocumentAiWarehouseLocation) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DocumentAiWarehouseLocation) MoveFromId(id *string) {
...
func (d *jsiiProxy_DocumentAiWarehouseLocation) MoveToId(id *string) {
...
func (d *jsiiProxy_DocumentAiWarehouseLocation) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DocumentAiWarehouseLocation) PutTimeouts(value *DocumentAiWarehouseLocationTimeouts) {
...
func (d *jsiiProxy_DocumentAiWarehouseLocation) ResetDocumentCreatorDefaultRole() {
	_jsii_.InvokeVoid(
		d,
		"resetDocumentCreatorDefaultRole",
		nil, // no parameters
...
func (d *jsiiProxy_DocumentAiWarehouseLocation) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DocumentAiWarehouseLocation) ResetKmsKey() {
	_jsii_.InvokeVoid(
		d,
		"resetKmsKey",
		nil, // no parameters
...
func (d *jsiiProxy_DocumentAiWarehouseLocation) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DocumentAiWarehouseLocation) ResetTimeouts() {
	_jsii_.InvokeVoid(
		d,
		"resetTimeouts",
		nil, // no parameters
...
func (d *jsiiProxy_DocumentAiWarehouseLocation) ToString() *string {
	var returns *string
