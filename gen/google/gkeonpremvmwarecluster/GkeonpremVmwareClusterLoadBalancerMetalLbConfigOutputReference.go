...
func (g *jsiiProxy_GkeonpremVmwareClusterLoadBalancerMetalLbConfigOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GkeonpremVmwareClusterLoadBalancerMetalLbConfigOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
