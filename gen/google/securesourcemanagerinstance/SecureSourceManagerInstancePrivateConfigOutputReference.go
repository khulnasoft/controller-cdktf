...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/securesourcemanagerinstance/internal"
)
...
func (j *jsiiProxy_SecureSourceManagerInstancePrivateConfigOutputReference) CaPoolInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"caPoolInput",
...
func (j *jsiiProxy_SecureSourceManagerInstancePrivateConfigOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SecureSourceManagerInstancePrivateConfigOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SecureSourceManagerInstancePrivateConfigOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SecureSourceManagerInstancePrivateConfigOutputReference) HttpServiceAttachment() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SecureSourceManagerInstancePrivateConfigOutputReference) InternalValue() *SecureSourceManagerInstancePrivateConfig {
...
func (j *jsiiProxy_SecureSourceManagerInstancePrivateConfigOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (s *jsiiProxy_SecureSourceManagerInstancePrivateConfigOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SecureSourceManagerInstancePrivateConfigOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_SecureSourceManagerInstancePrivateConfigOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (s *jsiiProxy_SecureSourceManagerInstancePrivateConfigOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (s *jsiiProxy_SecureSourceManagerInstancePrivateConfigOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_SecureSourceManagerInstancePrivateConfigOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_SecureSourceManagerInstancePrivateConfigOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (s *jsiiProxy_SecureSourceManagerInstancePrivateConfigOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_SecureSourceManagerInstancePrivateConfigOutputReference) ToString() *string {
	var returns *string
