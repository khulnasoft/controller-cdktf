...
func (k *jsiiProxy_KmsCryptoKeyVersion) AddMoveTarget(moveTarget *string) {
...
func (k *jsiiProxy_KmsCryptoKeyVersion) MoveFromId(id *string) {
...
func (k *jsiiProxy_KmsCryptoKeyVersion) MoveToId(id *string) {
