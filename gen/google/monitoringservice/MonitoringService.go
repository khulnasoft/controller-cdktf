...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/monitoringservice/internal"
)
...
func (j *jsiiProxy_MonitoringService) BasicService() MonitoringServiceBasicServiceOutputReference {
	var returns MonitoringServiceBasicServiceOutputReference
	_jsii_.Get(
		j,
		"basicService",
		&returns,
...
func (j *jsiiProxy_MonitoringService) BasicServiceInput() *MonitoringServiceBasicService {
...
func (j *jsiiProxy_MonitoringService) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_MonitoringService) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_MonitoringService) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_MonitoringService) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_MonitoringService) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_MonitoringService) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_MonitoringService) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_MonitoringService) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_MonitoringService) Node() constructs.Node {
...
func (j *jsiiProxy_MonitoringService) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_MonitoringService) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_MonitoringService) ServiceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceId",
...
func (j *jsiiProxy_MonitoringService) ServiceIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceIdInput",
...
func (j *jsiiProxy_MonitoringService) Telemetry() MonitoringServiceTelemetryList {
	var returns MonitoringServiceTelemetryList
	_jsii_.Get(
		j,
		"telemetry",
		&returns,
...
func (j *jsiiProxy_MonitoringService) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_MonitoringService) Timeouts() MonitoringServiceTimeoutsOutputReference {
	var returns MonitoringServiceTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_MonitoringService) UserLabels() *map[string]*string {
...
func (j *jsiiProxy_MonitoringService) UserLabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"userLabelsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/monitoring_service google_monitoring_service} Resource.
func NewMonitoringService(scope constructs.Construct, id *string, config *MonitoringServiceConfig) MonitoringService {
	_init_.Initialize()

	if err := validateNewMonitoringServiceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func MonitoringService_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.monitoringService.MonitoringService",
...
func (m *jsiiProxy_MonitoringService) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MonitoringService) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (m *jsiiProxy_MonitoringService) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (m *jsiiProxy_MonitoringService) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (m *jsiiProxy_MonitoringService) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (m *jsiiProxy_MonitoringService) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (m *jsiiProxy_MonitoringService) GetStringAttribute(terraformAttribute *string) *string {
...
func (m *jsiiProxy_MonitoringService) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (m *jsiiProxy_MonitoringService) MoveFromId(id *string) {
...
func (m *jsiiProxy_MonitoringService) MoveToId(id *string) {
...
func (m *jsiiProxy_MonitoringService) OverrideLogicalId(newLogicalId *string) {
...
func (m *jsiiProxy_MonitoringService) PutBasicService(value *MonitoringServiceBasicService) {
	if err := m.validatePutBasicServiceParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		m,
...
func (m *jsiiProxy_MonitoringService) PutTimeouts(value *MonitoringServiceTimeouts) {
...
func (m *jsiiProxy_MonitoringService) ResetBasicService() {
	_jsii_.InvokeVoid(
		m,
		"resetBasicService",
		nil, // no parameters
...
func (m *jsiiProxy_MonitoringService) ResetDisplayName() {
	_jsii_.InvokeVoid(
		m,
		"resetDisplayName",
		nil, // no parameters
...
func (m *jsiiProxy_MonitoringService) ResetId() {
	_jsii_.InvokeVoid(
		m,
		"resetId",
		nil, // no parameters
...
func (m *jsiiProxy_MonitoringService) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		m,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (m *jsiiProxy_MonitoringService) ResetProject() {
	_jsii_.InvokeVoid(
		m,
		"resetProject",
		nil, // no parameters
...
func (m *jsiiProxy_MonitoringService) ResetTimeouts() {
	_jsii_.InvokeVoid(
		m,
		"resetTimeouts",
		nil, // no parameters
...
func (m *jsiiProxy_MonitoringService) ResetUserLabels() {
	_jsii_.InvokeVoid(
		m,
		"resetUserLabels",
		nil, // no parameters
...
func (m *jsiiProxy_MonitoringService) ToString() *string {
	var returns *string
