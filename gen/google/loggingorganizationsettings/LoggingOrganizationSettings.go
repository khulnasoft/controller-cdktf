...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/logging_organization_settings google_logging_organization_settings}.
...
func (j *jsiiProxy_LoggingOrganizationSettings) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_LoggingOrganizationSettings) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LoggingOrganizationSettings) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_LoggingOrganizationSettings) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_LoggingOrganizationSettings) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_LoggingOrganizationSettings) KmsKeyName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyName",
...
func (j *jsiiProxy_LoggingOrganizationSettings) KmsKeyNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyNameInput",
...
func (j *jsiiProxy_LoggingOrganizationSettings) KmsServiceAccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsServiceAccountId",
...
func (j *jsiiProxy_LoggingOrganizationSettings) LoggingServiceAccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LoggingOrganizationSettings) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_LoggingOrganizationSettings) Node() constructs.Node {
...
func (j *jsiiProxy_LoggingOrganizationSettings) Organization() *string {
	var returns *string
	_jsii_.Get(
		j,
		"organization",
...
func (j *jsiiProxy_LoggingOrganizationSettings) OrganizationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"organizationInput",
...
func (j *jsiiProxy_LoggingOrganizationSettings) StorageLocation() *string {
	var returns *string
	_jsii_.Get(
		j,
		"storageLocation",
...
func (j *jsiiProxy_LoggingOrganizationSettings) StorageLocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LoggingOrganizationSettings) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LoggingOrganizationSettings) Timeouts() LoggingOrganizationSettingsTimeoutsOutputReference {
	var returns LoggingOrganizationSettingsTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/logging_organization_settings google_logging_organization_settings} Resource.
func NewLoggingOrganizationSettings(scope constructs.Construct, id *string, config *LoggingOrganizationSettingsConfig) LoggingOrganizationSettings {
	...
	if err := validateNewLoggingOrganizationSettingsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func LoggingOrganizationSettings_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.loggingOrganizationSettings.LoggingOrganizationSettings",
...
func (l *jsiiProxy_LoggingOrganizationSettings) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LoggingOrganizationSettings) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (l *jsiiProxy_LoggingOrganizationSettings) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (l *jsiiProxy_LoggingOrganizationSettings) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (l *jsiiProxy_LoggingOrganizationSettings) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (l *jsiiProxy_LoggingOrganizationSettings) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (l *jsiiProxy_LoggingOrganizationSettings) GetStringAttribute(terraformAttribute *string) *string {
...
func (l *jsiiProxy_LoggingOrganizationSettings) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (l *jsiiProxy_LoggingOrganizationSettings) MoveFromId(id *string) {
...
func (l *jsiiProxy_LoggingOrganizationSettings) MoveToId(id *string) {
...
func (l *jsiiProxy_LoggingOrganizationSettings) OverrideLogicalId(newLogicalId *string) {
...
func (l *jsiiProxy_LoggingOrganizationSettings) PutTimeouts(value *LoggingOrganizationSettingsTimeouts) {
...
func (l *jsiiProxy_LoggingOrganizationSettings) ResetDisableDefaultSink() {
	_jsii_.InvokeVoid(
		l,
		"resetDisableDefaultSink",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingOrganizationSettings) ResetId() {
	_jsii_.InvokeVoid(
		l,
		"resetId",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingOrganizationSettings) ResetKmsKeyName() {
	_jsii_.InvokeVoid(
		l,
		"resetKmsKeyName",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingOrganizationSettings) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		l,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingOrganizationSettings) ResetStorageLocation() {
	_jsii_.InvokeVoid(
		l,
		"resetStorageLocation",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingOrganizationSettings) ResetTimeouts() {
	_jsii_.InvokeVoid(
		l,
		"resetTimeouts",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingOrganizationSettings) ToString() *string {
	var returns *string
