...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/iam_workforce_pool_provider google_iam_workforce_pool_provider} Resource.
...
func IamWorkforcePoolProvider_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateIamWorkforcePoolProvider_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IamWorkforcePoolProvider) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IamWorkforcePoolProvider) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IamWorkforcePoolProvider) MoveFromId(id *string) {
...
func (i *jsiiProxy_IamWorkforcePoolProvider) MoveToId(id *string) {
