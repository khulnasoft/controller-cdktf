...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/data_loss_prevention_job_trigger google_data_loss_prevention_job_trigger}.
...
func (j *jsiiProxy_DataLossPreventionJobTrigger) TriggerId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"triggerId",
...
func (j *jsiiProxy_DataLossPreventionJobTrigger) TriggerIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"triggerIdInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/data_loss_prevention_job_trigger google_data_loss_prevention_job_trigger} Resource.
...
func (d *jsiiProxy_DataLossPreventionJobTrigger) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DataLossPreventionJobTrigger) MoveFromId(id *string) {
...
func (d *jsiiProxy_DataLossPreventionJobTrigger) MoveToId(id *string) {
...
func (d *jsiiProxy_DataLossPreventionJobTrigger) ResetTriggerId() {
	_jsii_.InvokeVoid(
		d,
		"resetTriggerId",
		nil, // no parameters
