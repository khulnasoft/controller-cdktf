...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/datastreamconnectionprofile/internal"
)
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/datastream_connection_profile google_datastream_connection_profile} Resource.
...
func DatastreamConnectionProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DatastreamConnectionProfile) ImportFrom(id *string, provider cdktf.TerraformProvider) {
