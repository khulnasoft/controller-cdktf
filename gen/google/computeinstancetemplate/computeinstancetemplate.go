...
func (j *jsiiProxy_ComputeInstanceTemplate) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_ComputeInstanceTemplate) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/compute_instance_template google_compute_instance_template} Resource.
...
func ComputeInstanceTemplate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateComputeInstanceTemplate_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ComputeInstanceTemplate) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ComputeInstanceTemplate) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ComputeInstanceTemplate) MoveFromId(id *string) {
...
func (c *jsiiProxy_ComputeInstanceTemplate) MoveToId(id *string) {
