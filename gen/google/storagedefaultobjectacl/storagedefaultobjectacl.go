...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/storagedefaultobjectacl/internal"
)
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/storage_default_object_acl google_storage_default_object_acl} Resource.
...
func (s *jsiiProxy_StorageDefaultObjectAcl) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_StorageDefaultObjectAcl) MoveFromId(id *string) {
...
func (s *jsiiProxy_StorageDefaultObjectAcl) MoveToId(id *string) {
