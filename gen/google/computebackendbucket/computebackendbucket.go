...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/computebackendbucket/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/compute_backend_bucket google_compute_backend_bucket}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/compute_backend_bucket google_compute_backend_bucket} Resource.
...
func ComputeBackendBucket_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateComputeBackendBucket_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ComputeBackendBucket) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ComputeBackendBucket) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ComputeBackendBucket) MoveFromId(id *string) {
...
func (c *jsiiProxy_ComputeBackendBucket) MoveToId(id *string) {
