...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/appenginedomainmapping/internal"
)
...
func (a *jsiiProxy_AppEngineDomainMappingResourceRecordsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
