...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/loggingprojectexclusion/internal"
)
...
func (l *jsiiProxy_LoggingProjectExclusion) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LoggingProjectExclusion) MoveFromId(id *string) {
...
func (l *jsiiProxy_LoggingProjectExclusion) MoveToId(id *string) {
