...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/spannerdatabaseiammember/internal"
)
...
type SpannerDatabaseIamMember interface {
	...
	PutCondition(value *SpannerDatabaseIamMemberCondition)
	ResetCondition()
	ResetId()
...
func (j *jsiiProxy_SpannerDatabaseIamMember) Condition() SpannerDatabaseIamMemberConditionOutputReference {
	var returns SpannerDatabaseIamMemberConditionOutputReference
	_jsii_.Get(
		j,
		"condition",
		&returns,
...
func (j *jsiiProxy_SpannerDatabaseIamMember) ConditionInput() *SpannerDatabaseIamMemberCondition {
...
func (j *jsiiProxy_SpannerDatabaseIamMember) Database() *string {
	var returns *string
	_jsii_.Get(
		j,
		"database",
...
func (j *jsiiProxy_SpannerDatabaseIamMember) DatabaseInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"databaseInput",
...
func (j *jsiiProxy_SpannerDatabaseIamMember) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_SpannerDatabaseIamMember) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_SpannerDatabaseIamMember) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SpannerDatabaseIamMember) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_SpannerDatabaseIamMember) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_SpannerDatabaseIamMember) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SpannerDatabaseIamMember) Instance() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instance",
...
func (j *jsiiProxy_SpannerDatabaseIamMember) InstanceInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceInput",
...
func (j *jsiiProxy_SpannerDatabaseIamMember) Member() *string {
	var returns *string
	_jsii_.Get(
		j,
		"member",
...
func (j *jsiiProxy_SpannerDatabaseIamMember) MemberInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"memberInput",
...
func (j *jsiiProxy_SpannerDatabaseIamMember) Node() constructs.Node {
...
func (j *jsiiProxy_SpannerDatabaseIamMember) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_SpannerDatabaseIamMember) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_SpannerDatabaseIamMember) Role() *string {
	var returns *string
	_jsii_.Get(
		j,
		"role",
...
func (j *jsiiProxy_SpannerDatabaseIamMember) RoleInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleInput",
...
func (j *jsiiProxy_SpannerDatabaseIamMember) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewSpannerDatabaseIamMember(scope constructs.Construct, id *string, config *SpannerDatabaseIamMemberConfig) SpannerDatabaseIamMember {
	...
	if err := validateNewSpannerDatabaseIamMemberParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_SpannerDatabaseIamMember{}
...
func SpannerDatabaseIamMember_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.spannerDatabaseIamMember.SpannerDatabaseIamMember",
...
func (s *jsiiProxy_SpannerDatabaseIamMember) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SpannerDatabaseIamMember) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_SpannerDatabaseIamMember) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (s *jsiiProxy_SpannerDatabaseIamMember) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (s *jsiiProxy_SpannerDatabaseIamMember) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_SpannerDatabaseIamMember) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_SpannerDatabaseIamMember) GetStringAttribute(terraformAttribute *string) *string {
...
func (s *jsiiProxy_SpannerDatabaseIamMember) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_SpannerDatabaseIamMember) MoveFromId(id *string) {
...
func (s *jsiiProxy_SpannerDatabaseIamMember) MoveToId(id *string) {
...
func (s *jsiiProxy_SpannerDatabaseIamMember) OverrideLogicalId(newLogicalId *string) {
...
func (s *jsiiProxy_SpannerDatabaseIamMember) PutCondition(value *SpannerDatabaseIamMemberCondition) {
...
func (s *jsiiProxy_SpannerDatabaseIamMember) ResetCondition() {
	_jsii_.InvokeVoid(
		s,
		"resetCondition",
		nil, // no parameters
...
func (s *jsiiProxy_SpannerDatabaseIamMember) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SpannerDatabaseIamMember) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		s,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (s *jsiiProxy_SpannerDatabaseIamMember) ResetProject() {
	_jsii_.InvokeVoid(
		s,
		"resetProject",
		nil, // no parameters
...
func (s *jsiiProxy_SpannerDatabaseIamMember) ToString() *string {
	var returns *string
