...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google/computeinstance/internal"
)
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/compute_instance google_compute_instance} Resource.
...
func (c *jsiiProxy_ComputeInstance) ImportFrom(id *string, provider cdktf.TerraformProvider) {
