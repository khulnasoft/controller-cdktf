...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/nobl9/alertmethodemail/internal"
)
...
type jsiiProxy_AlertMethodEmail struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_AlertMethodEmail) Bcc() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"bcc",
...
func (j *jsiiProxy_AlertMethodEmail) BccInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"bccInput",
...
func (j *jsiiProxy_AlertMethodEmail) Cc() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"cc",
...
func (j *jsiiProxy_AlertMethodEmail) CcInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"ccInput",
...
func (j *jsiiProxy_AlertMethodEmail) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_AlertMethodEmail) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_AlertMethodEmail) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_AlertMethodEmail) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_AlertMethodEmail) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_AlertMethodEmail) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_AlertMethodEmail) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AlertMethodEmail) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AlertMethodEmail) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_AlertMethodEmail) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_AlertMethodEmail) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_AlertMethodEmail) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AlertMethodEmail) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_AlertMethodEmail) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_AlertMethodEmail) Node() constructs.Node {
...
func (j *jsiiProxy_AlertMethodEmail) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_AlertMethodEmail) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_AlertMethodEmail) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_AlertMethodEmail) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AlertMethodEmail) To() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"to",
...
func (j *jsiiProxy_AlertMethodEmail) ToInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"toInput",
...
func NewAlertMethodEmail(scope constructs.Construct, id *string, config *AlertMethodEmailConfig) AlertMethodEmail {
	...
	if err := validateNewAlertMethodEmailParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AlertMethodEmail_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAlertMethodEmail_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func AlertMethodEmail_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-nobl9.alertMethodEmail.AlertMethodEmail",
...
func (a *jsiiProxy_AlertMethodEmail) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AlertMethodEmail) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AlertMethodEmail) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_AlertMethodEmail) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_AlertMethodEmail) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_AlertMethodEmail) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_AlertMethodEmail) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_AlertMethodEmail) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_AlertMethodEmail) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_AlertMethodEmail) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AlertMethodEmail) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AlertMethodEmail) MoveFromId(id *string) {
...
func (a *jsiiProxy_AlertMethodEmail) MoveToId(id *string) {
...
func (a *jsiiProxy_AlertMethodEmail) OverrideLogicalId(newLogicalId *string) {
...
func (a *jsiiProxy_AlertMethodEmail) ResetBcc() {
	_jsii_.InvokeVoid(
		a,
		"resetBcc",
		nil, // no parameters
...
func (a *jsiiProxy_AlertMethodEmail) ResetDescription() {
	_jsii_.InvokeVoid(
		a,
		"resetDescription",
		nil, // no parameters
...
func (a *jsiiProxy_AlertMethodEmail) ResetDisplayName() {
	_jsii_.InvokeVoid(
		a,
		"resetDisplayName",
		nil, // no parameters
...
func (a *jsiiProxy_AlertMethodEmail) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_AlertMethodEmail) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_AlertMethodEmail) ToString() *string {
	var returns *string
