...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/nobl9/directgcm/internal"
)
...
type jsiiProxy_DirectGcm struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_DirectGcm) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DirectGcm) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DirectGcm) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_DirectGcm) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_DirectGcm) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_DirectGcm) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_DirectGcm) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DirectGcm) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DirectGcm) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DirectGcm) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DirectGcm) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DirectGcm) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DirectGcm) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DirectGcm) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_DirectGcm) Node() constructs.Node {
...
func (j *jsiiProxy_DirectGcm) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DirectGcm) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DirectGcm) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DirectGcm) QueryDelay() DirectGcmQueryDelayOutputReference {
	var returns DirectGcmQueryDelayOutputReference
	_jsii_.Get(
		j,
		"queryDelay",
		&returns,
...
func (j *jsiiProxy_DirectGcm) QueryDelayInput() *DirectGcmQueryDelay {
...
func (j *jsiiProxy_DirectGcm) ReleaseChannel() *string {
	var returns *string
	_jsii_.Get(
		j,
		"releaseChannel",
...
func (j *jsiiProxy_DirectGcm) ReleaseChannelInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"releaseChannelInput",
...
func (j *jsiiProxy_DirectGcm) ServiceAccountKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceAccountKey",
...
func (j *jsiiProxy_DirectGcm) ServiceAccountKeyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DirectGcm) SourceOf() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"sourceOf",
...
func (j *jsiiProxy_DirectGcm) SourceOfInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"sourceOfInput",
...
func (j *jsiiProxy_DirectGcm) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_DirectGcm) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DirectGcm) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewDirectGcm(scope constructs.Construct, id *string, config *DirectGcmConfig) DirectGcm {
	...
	if err := validateNewDirectGcmParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DirectGcm_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDirectGcm_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DirectGcm_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-nobl9.directGcm.DirectGcm",
...
func (d *jsiiProxy_DirectGcm) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DirectGcm) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DirectGcm) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DirectGcm) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DirectGcm) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DirectGcm) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DirectGcm) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DirectGcm) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DirectGcm) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DirectGcm) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DirectGcm) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DirectGcm) MoveFromId(id *string) {
...
func (d *jsiiProxy_DirectGcm) MoveToId(id *string) {
...
func (d *jsiiProxy_DirectGcm) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DirectGcm) ResetDescription() {
	_jsii_.InvokeVoid(
		d,
		"resetDescription",
		nil, // no parameters
...
func (d *jsiiProxy_DirectGcm) ResetDisplayName() {
	_jsii_.InvokeVoid(
		d,
		"resetDisplayName",
		nil, // no parameters
...
func (d *jsiiProxy_DirectGcm) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DirectGcm) ResetLogCollectionEnabled() {
	_jsii_.InvokeVoid(
		d,
		"resetLogCollectionEnabled",
		nil, // no parameters
...
func (d *jsiiProxy_DirectGcm) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DirectGcm) ResetQueryDelay() {
	_jsii_.InvokeVoid(
		d,
		"resetQueryDelay",
		nil, // no parameters
...
func (d *jsiiProxy_DirectGcm) ResetReleaseChannel() {
	_jsii_.InvokeVoid(
		d,
		"resetReleaseChannel",
		nil, // no parameters
...
func (d *jsiiProxy_DirectGcm) ResetServiceAccountKey() {
	_jsii_.InvokeVoid(
		d,
		"resetServiceAccountKey",
		nil, // no parameters
...
func (d *jsiiProxy_DirectGcm) ToString() *string {
	var returns *string
