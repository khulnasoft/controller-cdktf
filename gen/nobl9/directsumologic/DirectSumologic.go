...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/nobl9/directsumologic/internal"
)
...
// Generates CDKTF code for importing a DirectSumologic resource upon running "cdktf plan <stack-name>".
func DirectSumologic_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDirectSumologic_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DirectSumologic) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DirectSumologic) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DirectSumologic) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DirectSumologic) MoveFromId(id *string) {
...
func (d *jsiiProxy_DirectSumologic) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DirectSumologic) MoveToId(id *string) {
...
func (d *jsiiProxy_DirectSumologic) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DirectSumologic) ToHclTerraform() interface{} {
	var returns interface{}
