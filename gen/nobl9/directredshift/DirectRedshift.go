...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/nobl9/directredshift/internal"
)
...
func DirectRedshift_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDirectRedshift_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DirectRedshift) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DirectRedshift) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DirectRedshift) MoveFromId(id *string) {
...
func (d *jsiiProxy_DirectRedshift) MoveToId(id *string) {
