...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/nobl9/directthousandeyes/internal"
)
...
func DirectThousandeyes_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateDirectThousandeyes_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DirectThousandeyes) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DirectThousandeyes) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DirectThousandeyes) MoveFromId(id *string) {
...
func (d *jsiiProxy_DirectThousandeyes) MoveToId(id *string) {
