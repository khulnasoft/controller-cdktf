...
func DirectDynatrace_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDirectDynatrace_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DirectDynatrace) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DirectDynatrace) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DirectDynatrace) MoveFromId(id *string) {
...
func (d *jsiiProxy_DirectDynatrace) MoveToId(id *string) {
