...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google_beta/datagooglecloudfunctions2functioniampolicy/internal"
)
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/data-sources/google_cloudfunctions2_function_iam_policy google_cloudfunctions2_function_iam_policy} Data Source.
func NewDataGoogleCloudfunctions2FunctionIamPolicy(scope constructs.Construct, id *string, config *DataGoogleCloudfunctions2FunctionIamPolicyConfig) DataGoogleCloudfunctions2FunctionIamPolicy {
	...
	_jsii_.Create(
		"@cdktf/provider-google-beta.dataGoogleCloudfunctions2FunctionIamPolicy.DataGoogleCloudfunctions2FunctionIamPolicy",
