...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google_beta/googlecomputeglobaladdress/internal"
)
...
func (g *jsiiProxy_GoogleComputeGlobalAddress) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleComputeGlobalAddress) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleComputeGlobalAddress) MoveToId(id *string) {
