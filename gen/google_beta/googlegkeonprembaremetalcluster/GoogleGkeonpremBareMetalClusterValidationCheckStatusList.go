...
func (j *jsiiProxy_GoogleGkeonpremBareMetalClusterValidationCheckStatusList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleGkeonpremBareMetalClusterValidationCheckStatusList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleGkeonpremBareMetalClusterValidationCheckStatusList {
	_init_.Initialize()
...
func NewGoogleGkeonpremBareMetalClusterValidationCheckStatusList_Override(g GoogleGkeonpremBareMetalClusterValidationCheckStatusList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleGkeonpremBareMetalClusterValidationCheckStatusList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalClusterValidationCheckStatusList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalClusterValidationCheckStatusList) Resolve(_context cdktf.IResolveContext) interface{} {
