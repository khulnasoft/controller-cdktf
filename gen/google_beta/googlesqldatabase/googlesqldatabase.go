...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google_beta/googlesqldatabase/internal"
)
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_sql_database google_sql_database} Resource.
...
func GoogleSqlDatabase_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleSqlDatabase) ImportFrom(id *string, provider cdktf.TerraformProvider) {
