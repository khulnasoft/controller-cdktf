...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google_beta/datagooglebigquerydataset/internal"
)
...
func (j *jsiiProxy_DataGoogleBigqueryDatasetExternalDatasetReferenceList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleBigqueryDatasetExternalDatasetReferenceList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleBigqueryDatasetExternalDatasetReferenceList {
	_init_.Initialize()
...
func NewDataGoogleBigqueryDatasetExternalDatasetReferenceList_Override(d DataGoogleBigqueryDatasetExternalDatasetReferenceList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleBigqueryDatasetExternalDatasetReferenceList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleBigqueryDatasetExternalDatasetReferenceList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleBigqueryDatasetExternalDatasetReferenceList) Resolve(_context cdktf.IResolveContext) interface{} {
