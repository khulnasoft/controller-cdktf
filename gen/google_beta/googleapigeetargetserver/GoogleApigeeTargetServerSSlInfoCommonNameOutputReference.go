...
type GoogleApigeeTargetServerSSlInfoCommonNameOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *GoogleApigeeTargetServerSSlInfoCommonName
	SetInternalValue(val *GoogleApigeeTargetServerSSlInfoCommonName)
	// Experimental.
...
func (j *jsiiProxy_GoogleApigeeTargetServerSSlInfoCommonNameOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleApigeeTargetServerSSlInfoCommonNameOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_GoogleApigeeTargetServerSSlInfoCommonNameOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleApigeeTargetServerSSlInfoCommonNameOutputReference) InternalValue() *GoogleApigeeTargetServerSSlInfoCommonName {
...
func (j *jsiiProxy_GoogleApigeeTargetServerSSlInfoCommonNameOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_GoogleApigeeTargetServerSSlInfoCommonNameOutputReference) Value() *string {
	var returns *string
	_jsii_.Get(
		j,
		"value",
...
func (j *jsiiProxy_GoogleApigeeTargetServerSSlInfoCommonNameOutputReference) ValueInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"valueInput",
...
func (g *jsiiProxy_GoogleApigeeTargetServerSSlInfoCommonNameOutputReference) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GoogleApigeeTargetServerSSlInfoCommonNameOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GoogleApigeeTargetServerSSlInfoCommonNameOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GoogleApigeeTargetServerSSlInfoCommonNameOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GoogleApigeeTargetServerSSlInfoCommonNameOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GoogleApigeeTargetServerSSlInfoCommonNameOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GoogleApigeeTargetServerSSlInfoCommonNameOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GoogleApigeeTargetServerSSlInfoCommonNameOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GoogleApigeeTargetServerSSlInfoCommonNameOutputReference) ResetValue() {
	_jsii_.InvokeVoid(
		g,
		"resetValue",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleApigeeTargetServerSSlInfoCommonNameOutputReference) ResetWildcardMatch() {
	_jsii_.InvokeVoid(
		g,
		"resetWildcardMatch",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleApigeeTargetServerSSlInfoCommonNameOutputReference) ToString() *string {
	var returns *string
