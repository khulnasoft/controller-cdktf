...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google_beta/googlecertificatemanagercertificatemapentry/internal"
)
...
func GoogleCertificateManagerCertificateMapEntry_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleCertificateManagerCertificateMapEntry_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleCertificateManagerCertificateMapEntry) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleCertificateManagerCertificateMapEntry) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleCertificateManagerCertificateMapEntry) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleCertificateManagerCertificateMapEntry) MoveToId(id *string) {
