...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google_beta/googledataflowjob/internal"
)
...
func GoogleDataflowJob_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleDataflowJob) ImportFrom(id *string, provider cdktf.TerraformProvider) {
