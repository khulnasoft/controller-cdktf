...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google_beta/datagooglecomputeinstancetemplate/internal"
)
...
func (d *jsiiProxy_DataGoogleComputeInstanceTemplateDiskSourceSnapshotEncryptionKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
