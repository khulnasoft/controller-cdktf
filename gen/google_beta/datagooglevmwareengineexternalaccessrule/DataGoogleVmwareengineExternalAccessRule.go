...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google_beta/datagooglevmwareengineexternalaccessrule/internal"
)
...
func (j *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) DestinationIpRanges() DataGoogleVmwareengineExternalAccessRuleDestinationIpRangesList {
	var returns DataGoogleVmwareengineExternalAccessRuleDestinationIpRangesList
	_jsii_.Get(
		j,
		"destinationIpRanges",
		&returns,
...
func (j *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) DestinationPorts() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"destinationPorts",
...
func (j *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) IpProtocol() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipProtocol",
...
func (j *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) Parent() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parent",
...
func (j *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) ParentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parentInput",
...
func (j *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) Priority() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"priority",
...
func (j *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) SourceIpRanges() DataGoogleVmwareengineExternalAccessRuleSourceIpRangesList {
	var returns DataGoogleVmwareengineExternalAccessRuleSourceIpRangesList
	_jsii_.Get(
		j,
		"sourceIpRanges",
		&returns,
...
func (j *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) SourcePorts() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"sourcePorts",
...
func (j *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) Uid() *string {
	var returns *string
	_jsii_.Get(
		j,
		"uid",
...
func (j *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/data-sources/google_vmwareengine_external_access_rule google_vmwareengine_external_access_rule} Data Source.
func NewDataGoogleVmwareengineExternalAccessRule(scope constructs.Construct, id *string, config *DataGoogleVmwareengineExternalAccessRuleConfig) DataGoogleVmwareengineExternalAccessRule {
	...
	if err := validateNewDataGoogleVmwareengineExternalAccessRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataGoogleVmwareengineExternalAccessRule{}

	_jsii_.Create(
		"@cdktf/provider-google-beta.dataGoogleVmwareengineExternalAccessRule.DataGoogleVmwareengineExternalAccessRule",
...
func DataGoogleVmwareengineExternalAccessRule_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google-beta.dataGoogleVmwareengineExternalAccessRule.DataGoogleVmwareengineExternalAccessRule",
...
func (d *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleVmwareengineExternalAccessRule) ToString() *string {
	var returns *string
