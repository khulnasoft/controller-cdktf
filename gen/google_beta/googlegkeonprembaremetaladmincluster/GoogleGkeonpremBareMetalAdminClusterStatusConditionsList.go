...
func (j *jsiiProxy_GoogleGkeonpremBareMetalAdminClusterStatusConditionsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleGkeonpremBareMetalAdminClusterStatusConditionsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleGkeonpremBareMetalAdminClusterStatusConditionsList {
	_init_.Initialize()
...
func NewGoogleGkeonpremBareMetalAdminClusterStatusConditionsList_Override(g GoogleGkeonpremBareMetalAdminClusterStatusConditionsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleGkeonpremBareMetalAdminClusterStatusConditionsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalAdminClusterStatusConditionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalAdminClusterStatusConditionsList) Resolve(_context cdktf.IResolveContext) interface{} {
