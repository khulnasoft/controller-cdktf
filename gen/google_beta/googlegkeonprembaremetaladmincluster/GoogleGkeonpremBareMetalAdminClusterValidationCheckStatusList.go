...
func (j *jsiiProxy_GoogleGkeonpremBareMetalAdminClusterValidationCheckStatusList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleGkeonpremBareMetalAdminClusterValidationCheckStatusList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleGkeonpremBareMetalAdminClusterValidationCheckStatusList {
	_init_.Initialize()
...
func NewGoogleGkeonpremBareMetalAdminClusterValidationCheckStatusList_Override(g GoogleGkeonpremBareMetalAdminClusterValidationCheckStatusList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleGkeonpremBareMetalAdminClusterValidationCheckStatusList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalAdminClusterValidationCheckStatusList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalAdminClusterValidationCheckStatusList) Resolve(_context cdktf.IResolveContext) interface{} {
