...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicyRulePreconfiguredWafConfigExclusionRequestCookieList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
