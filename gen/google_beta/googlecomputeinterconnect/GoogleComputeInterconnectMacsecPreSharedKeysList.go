...
func (j *jsiiProxy_GoogleComputeInterconnectMacsecPreSharedKeysList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleComputeInterconnectMacsecPreSharedKeysList) InternalValue() interface{} {
...
func (j *jsiiProxy_GoogleComputeInterconnectMacsecPreSharedKeysList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_GoogleComputeInterconnectMacsecPreSharedKeysList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_GoogleComputeInterconnectMacsecPreSharedKeysList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_GoogleComputeInterconnectMacsecPreSharedKeysList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_GoogleComputeInterconnectMacsecPreSharedKeysList)SetWrapsSet(val *bool) {
...
func (g *jsiiProxy_GoogleComputeInterconnectMacsecPreSharedKeysList) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GoogleComputeInterconnectMacsecPreSharedKeysList) Get(index *float64) GoogleComputeInterconnectMacsecPreSharedKeysOutputReference {
	if err := g.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns GoogleComputeInterconnectMacsecPreSharedKeysOutputReference
...
func (g *jsiiProxy_GoogleComputeInterconnectMacsecPreSharedKeysList) ToString() *string {
	var returns *string
