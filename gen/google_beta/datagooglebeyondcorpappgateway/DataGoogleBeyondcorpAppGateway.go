...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google_beta/datagooglebeyondcorpappgateway/internal"
)
...
func (j *jsiiProxy_DataGoogleBeyondcorpAppGateway) AllocatedConnections() DataGoogleBeyondcorpAppGatewayAllocatedConnectionsList {
	var returns DataGoogleBeyondcorpAppGatewayAllocatedConnectionsList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleBeyondcorpAppGateway) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleBeyondcorpAppGateway) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_DataGoogleBeyondcorpAppGateway) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleBeyondcorpAppGateway) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleBeyondcorpAppGateway) HostType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"hostType",
...
func (j *jsiiProxy_DataGoogleBeyondcorpAppGateway) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleBeyondcorpAppGateway) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleBeyondcorpAppGateway) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataGoogleBeyondcorpAppGateway) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_DataGoogleBeyondcorpAppGateway) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleBeyondcorpAppGateway) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleBeyondcorpAppGateway) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleBeyondcorpAppGateway) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataGoogleBeyondcorpAppGateway) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataGoogleBeyondcorpAppGateway) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_DataGoogleBeyondcorpAppGateway) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleBeyondcorpAppGateway) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_DataGoogleBeyondcorpAppGateway) Uri() *string {
	var returns *string
	_jsii_.Get(
		j,
		"uri",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/data-sources/google_beyondcorp_app_gateway google_beyondcorp_app_gateway} Data Source.
func NewDataGoogleBeyondcorpAppGateway(scope constructs.Construct, id *string, config *DataGoogleBeyondcorpAppGatewayConfig) DataGoogleBeyondcorpAppGateway {
	...
	if err := validateNewDataGoogleBeyondcorpAppGatewayParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataGoogleBeyondcorpAppGateway_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google-beta.dataGoogleBeyondcorpAppGateway.DataGoogleBeyondcorpAppGateway",
...
func (d *jsiiProxy_DataGoogleBeyondcorpAppGateway) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleBeyondcorpAppGateway) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleBeyondcorpAppGateway) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleBeyondcorpAppGateway) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleBeyondcorpAppGateway) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleBeyondcorpAppGateway) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleBeyondcorpAppGateway) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleBeyondcorpAppGateway) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleBeyondcorpAppGateway) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleBeyondcorpAppGateway) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleBeyondcorpAppGateway) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleBeyondcorpAppGateway) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleBeyondcorpAppGateway) ToString() *string {
	var returns *string
