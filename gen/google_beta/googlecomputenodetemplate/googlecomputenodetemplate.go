...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_compute_node_template google_compute_node_template} Resource.
...
func (g *jsiiProxy_GoogleComputeNodeTemplate) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleComputeNodeTemplate) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleComputeNodeTemplate) MoveToId(id *string) {
