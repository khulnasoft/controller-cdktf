...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google_beta/googlecomputebackendservicesignedurlkey/internal"
)
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_compute_backend_service_signed_url_key google_compute_backend_service_signed_url_key} Resource.
...
func (g *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) MoveToId(id *string) {
