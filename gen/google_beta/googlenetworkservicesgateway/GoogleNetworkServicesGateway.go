...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_network_services_gateway google_network_services_gateway}.
...
func (j *jsiiProxy_GoogleNetworkServicesGateway) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_GoogleNetworkServicesGateway) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleNetworkServicesGateway) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_GoogleNetworkServicesGateway) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_network_services_gateway google_network_services_gateway} Resource.
...
func GoogleNetworkServicesGateway_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleNetworkServicesGateway) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleNetworkServicesGateway) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleNetworkServicesGateway) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
