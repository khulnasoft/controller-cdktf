...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google_beta/googledialogflowagent/internal"
)
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_dialogflow_agent google_dialogflow_agent} Resource.
...
func GoogleDialogflowAgent_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleDialogflowAgent) ImportFrom(id *string, provider cdktf.TerraformProvider) {
