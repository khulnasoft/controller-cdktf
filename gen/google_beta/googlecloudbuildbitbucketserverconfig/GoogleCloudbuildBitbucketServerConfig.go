...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_cloudbuild_bitbucket_server_config google_cloudbuild_bitbucket_server_config}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_cloudbuild_bitbucket_server_config google_cloudbuild_bitbucket_server_config} Resource.
...
func GoogleCloudbuildBitbucketServerConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleCloudbuildBitbucketServerConfig_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleCloudbuildBitbucketServerConfig) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleCloudbuildBitbucketServerConfig) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleCloudbuildBitbucketServerConfig) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleCloudbuildBitbucketServerConfig) MoveToId(id *string) {
