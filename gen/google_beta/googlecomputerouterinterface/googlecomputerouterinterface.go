...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google_beta/googlecomputerouterinterface/internal"
)
...
func (j *jsiiProxy_GoogleComputeRouterInterface) IpVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipVersion",
...
func (j *jsiiProxy_GoogleComputeRouterInterface) IpVersionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipVersionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_compute_router_interface google_compute_router_interface} Resource.
...
func GoogleComputeRouterInterface_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleComputeRouterInterface_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleComputeRouterInterface) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleComputeRouterInterface) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleComputeRouterInterface) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleComputeRouterInterface) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleComputeRouterInterface) ResetIpVersion() {
	_jsii_.InvokeVoid(
		g,
		"resetIpVersion",
		nil, // no parameters
