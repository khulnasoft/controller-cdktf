...
func (j *jsiiProxy_GoogleComputeImage) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_GoogleComputeImage) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_compute_image google_compute_image} Resource.
...
func GoogleComputeImage_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleComputeImage) ImportFrom(id *string, provider cdktf.TerraformProvider) {
