...
func (d *jsiiProxy_DataGoogleContainerClusterResourceUsageExportConfigBigqueryDestinationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
