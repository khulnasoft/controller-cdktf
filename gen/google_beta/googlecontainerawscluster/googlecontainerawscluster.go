...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_container_aws_cluster google_container_aws_cluster} Resource.
...
func GoogleContainerAwsCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleContainerAwsCluster_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleContainerAwsCluster) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleContainerAwsCluster) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleContainerAwsCluster) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleContainerAwsCluster) MoveToId(id *string) {
