...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google_beta/googlecloudbuildworkerpool/internal"
)
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_cloudbuild_worker_pool google_cloudbuild_worker_pool} Resource.
...
func (g *jsiiProxy_GoogleCloudbuildWorkerPool) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleCloudbuildWorkerPool) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GoogleCloudbuildWorkerPool) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleCloudbuildWorkerPool) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GoogleCloudbuildWorkerPool) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleCloudbuildWorkerPool) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GoogleCloudbuildWorkerPool) ToHclTerraform() interface{} {
	var returns interface{}
