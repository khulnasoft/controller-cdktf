...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google_beta/googleproject/internal"
)
...
func (j *jsiiProxy_GoogleProject) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_GoogleProject) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
func GoogleProject_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleProject_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleProject) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleProject) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleProject) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleProject) MoveToId(id *string) {
