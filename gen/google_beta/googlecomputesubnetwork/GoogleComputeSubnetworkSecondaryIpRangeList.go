...
func (j *jsiiProxy_GoogleComputeSubnetworkSecondaryIpRangeList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleComputeSubnetworkSecondaryIpRangeList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleComputeSubnetworkSecondaryIpRangeList {
	_init_.Initialize()
...
func NewGoogleComputeSubnetworkSecondaryIpRangeList_Override(g GoogleComputeSubnetworkSecondaryIpRangeList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleComputeSubnetworkSecondaryIpRangeList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleComputeSubnetworkSecondaryIpRangeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleComputeSubnetworkSecondaryIpRangeList) Resolve(_context cdktf.IResolveContext) interface{} {
