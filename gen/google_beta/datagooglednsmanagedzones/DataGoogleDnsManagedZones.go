...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google_beta/datagooglednsmanagedzones/internal"
)
...
func (j *jsiiProxy_DataGoogleDnsManagedZones) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleDnsManagedZones) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleDnsManagedZones) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleDnsManagedZones) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleDnsManagedZones) ManagedZones() DataGoogleDnsManagedZonesManagedZonesList {
	var returns DataGoogleDnsManagedZonesManagedZonesList
	_jsii_.Get(
		j,
		"managedZones",
		&returns,
...
func (j *jsiiProxy_DataGoogleDnsManagedZones) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleDnsManagedZones) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleDnsManagedZones) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/data-sources/google_dns_managed_zones google_dns_managed_zones} Data Source.
func NewDataGoogleDnsManagedZones(scope constructs.Construct, id *string, config *DataGoogleDnsManagedZonesConfig) DataGoogleDnsManagedZones {
	...
	if err := validateNewDataGoogleDnsManagedZonesParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataGoogleDnsManagedZones_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google-beta.dataGoogleDnsManagedZones.DataGoogleDnsManagedZones",
...
func (d *jsiiProxy_DataGoogleDnsManagedZones) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleDnsManagedZones) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleDnsManagedZones) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleDnsManagedZones) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleDnsManagedZones) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleDnsManagedZones) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleDnsManagedZones) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleDnsManagedZones) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleDnsManagedZones) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleDnsManagedZones) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleDnsManagedZones) ToString() *string {
	var returns *string
