...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_organization_policy google_organization_policy} Resource.
...
func GoogleOrganizationPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleOrganizationPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleOrganizationPolicy) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleOrganizationPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GoogleOrganizationPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleOrganizationPolicy) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleOrganizationPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GoogleOrganizationPolicy) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleOrganizationPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GoogleOrganizationPolicy) ToHclTerraform() interface{} {
	var returns interface{}
