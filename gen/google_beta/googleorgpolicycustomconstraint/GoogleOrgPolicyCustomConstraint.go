...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google_beta/googleorgpolicycustomconstraint/internal"
)
...
type jsiiProxy_GoogleOrgPolicyCustomConstraint struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) ActionType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"actionType",
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) ActionTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"actionTypeInput",
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) Condition() *string {
	var returns *string
	_jsii_.Get(
		j,
		"condition",
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) ConditionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"conditionInput",
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) MethodTypes() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"methodTypes",
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) MethodTypesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"methodTypesInput",
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) Node() constructs.Node {
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) Parent() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parent",
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) ParentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parentInput",
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) ResourceTypes() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"resourceTypes",
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) ResourceTypesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"resourceTypesInput",
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) Timeouts() GoogleOrgPolicyCustomConstraintTimeoutsOutputReference {
	var returns GoogleOrgPolicyCustomConstraintTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_GoogleOrgPolicyCustomConstraint) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_org_policy_custom_constraint google_org_policy_custom_constraint} Resource.
func NewGoogleOrgPolicyCustomConstraint(scope constructs.Construct, id *string, config *GoogleOrgPolicyCustomConstraintConfig) GoogleOrgPolicyCustomConstraint {
	...
	if err := validateNewGoogleOrgPolicyCustomConstraintParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func GoogleOrgPolicyCustomConstraint_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google-beta.googleOrgPolicyCustomConstraint.GoogleOrgPolicyCustomConstraint",
...
func (g *jsiiProxy_GoogleOrgPolicyCustomConstraint) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleOrgPolicyCustomConstraint) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GoogleOrgPolicyCustomConstraint) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GoogleOrgPolicyCustomConstraint) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GoogleOrgPolicyCustomConstraint) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GoogleOrgPolicyCustomConstraint) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GoogleOrgPolicyCustomConstraint) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GoogleOrgPolicyCustomConstraint) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GoogleOrgPolicyCustomConstraint) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleOrgPolicyCustomConstraint) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleOrgPolicyCustomConstraint) PutTimeouts(value *GoogleOrgPolicyCustomConstraintTimeouts) {
...
func (g *jsiiProxy_GoogleOrgPolicyCustomConstraint) ResetDescription() {
	_jsii_.InvokeVoid(
		g,
		"resetDescription",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleOrgPolicyCustomConstraint) ResetDisplayName() {
	_jsii_.InvokeVoid(
		g,
		"resetDisplayName",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleOrgPolicyCustomConstraint) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleOrgPolicyCustomConstraint) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		g,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleOrgPolicyCustomConstraint) ResetTimeouts() {
	_jsii_.InvokeVoid(
		g,
		"resetTimeouts",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleOrgPolicyCustomConstraint) ToString() *string {
	var returns *string
