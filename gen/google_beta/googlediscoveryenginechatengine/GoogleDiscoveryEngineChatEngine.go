...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_discovery_engine_chat_engine google_discovery_engine_chat_engine} Resource.
...
func GoogleDiscoveryEngineChatEngine_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleDiscoveryEngineChatEngine_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleDiscoveryEngineChatEngine) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleDiscoveryEngineChatEngine) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleDiscoveryEngineChatEngine) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleDiscoveryEngineChatEngine) MoveToId(id *string) {
