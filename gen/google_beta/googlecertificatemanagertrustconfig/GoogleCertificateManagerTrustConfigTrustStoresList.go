...
func (j *jsiiProxy_GoogleCertificateManagerTrustConfigTrustStoresList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleCertificateManagerTrustConfigTrustStoresList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleCertificateManagerTrustConfigTrustStoresList {
	_init_.Initialize()
...
func NewGoogleCertificateManagerTrustConfigTrustStoresList_Override(g GoogleCertificateManagerTrustConfigTrustStoresList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleCertificateManagerTrustConfigTrustStoresList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleCertificateManagerTrustConfigTrustStoresList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleCertificateManagerTrustConfigTrustStoresList) Resolve(_context cdktf.IResolveContext) interface{} {
