...
func (g *jsiiProxy_GoogleComputePacketMirroringMirroredResourcesSubnetworksList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
