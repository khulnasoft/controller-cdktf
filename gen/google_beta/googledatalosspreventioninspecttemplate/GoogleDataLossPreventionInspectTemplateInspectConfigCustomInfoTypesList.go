...
func (g *jsiiProxy_GoogleDataLossPreventionInspectTemplateInspectConfigCustomInfoTypesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
