...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google_beta/googleprojectaccessapprovalsettings/internal"
)
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_project_access_approval_settings google_project_access_approval_settings} Resource.
...
func (g *jsiiProxy_GoogleProjectAccessApprovalSettings) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleProjectAccessApprovalSettings) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleProjectAccessApprovalSettings) MoveToId(id *string) {
