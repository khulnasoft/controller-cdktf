...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google_beta/googleapigeeenvironment/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_apigee_environment google_apigee_environment}.
...
func (j *jsiiProxy_GoogleApigeeEnvironment) ForwardProxyUri() *string {
	var returns *string
	_jsii_.Get(
		j,
		"forwardProxyUri",
...
func (j *jsiiProxy_GoogleApigeeEnvironment) ForwardProxyUriInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_apigee_environment google_apigee_environment} Resource.
...
func GoogleApigeeEnvironment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleApigeeEnvironment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleApigeeEnvironment) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleApigeeEnvironment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleApigeeEnvironment) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleApigeeEnvironment) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleApigeeEnvironment) ResetForwardProxyUri() {
	_jsii_.InvokeVoid(
		g,
		"resetForwardProxyUri",
		nil, // no parameters
