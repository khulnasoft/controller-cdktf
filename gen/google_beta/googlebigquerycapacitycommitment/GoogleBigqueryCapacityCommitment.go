...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google_beta/googlebigquerycapacitycommitment/internal"
)
...
func GoogleBigqueryCapacityCommitment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleBigqueryCapacityCommitment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleBigqueryCapacityCommitment) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleBigqueryCapacityCommitment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleBigqueryCapacityCommitment) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleBigqueryCapacityCommitment) MoveToId(id *string) {
