...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/google_beta/googlenetworkservicesedgecachekeyset/internal"
)
...
func GoogleNetworkServicesEdgeCacheKeyset_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleNetworkServicesEdgeCacheKeyset_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleNetworkServicesEdgeCacheKeyset) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleNetworkServicesEdgeCacheKeyset) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleNetworkServicesEdgeCacheKeyset) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleNetworkServicesEdgeCacheKeyset) MoveToId(id *string) {
