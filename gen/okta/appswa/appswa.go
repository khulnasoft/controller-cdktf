...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/okta/appswa/internal"
)
...
func AppSwa_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAppSwa_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppSwa) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AppSwa) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AppSwa) MoveFromId(id *string) {
...
func (a *jsiiProxy_AppSwa) MoveToId(id *string) {
