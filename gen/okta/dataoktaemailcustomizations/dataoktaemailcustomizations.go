...
// Represents a {@link https://registry.terraform.io/providers/okta/okta/4.11.1/docs/data-sources/email_customizations okta_email_customizations}.
type DataOktaEmailCustomizations interface {
	...
	EmailCustomizations() DataOktaEmailCustomizationsEmailCustomizationsList
	// Experimental.
...
// The jsii proxy struct for DataOktaEmailCustomizations
type jsiiProxy_DataOktaEmailCustomizations struct {
	internal.Type__cdktfTerraformDataSource
}

func (j *jsiiProxy_DataOktaEmailCustomizations) BrandId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"brandId",
...
func (j *jsiiProxy_DataOktaEmailCustomizations) BrandIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"brandIdInput",
...
func (j *jsiiProxy_DataOktaEmailCustomizations) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataOktaEmailCustomizations) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_DataOktaEmailCustomizations) Count() interface{} {
...
func (j *jsiiProxy_DataOktaEmailCustomizations) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataOktaEmailCustomizations) EmailCustomizations() DataOktaEmailCustomizationsEmailCustomizationsList {
	var returns DataOktaEmailCustomizationsEmailCustomizationsList
	_jsii_.Get(
		j,
		"emailCustomizations",
		&returns,
...
func (j *jsiiProxy_DataOktaEmailCustomizations) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataOktaEmailCustomizations) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataOktaEmailCustomizations) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataOktaEmailCustomizations) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataOktaEmailCustomizations) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataOktaEmailCustomizations) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataOktaEmailCustomizations) Node() constructs.Node {
...
func (j *jsiiProxy_DataOktaEmailCustomizations) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataOktaEmailCustomizations) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_DataOktaEmailCustomizations) TemplateName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"templateName",
...
func (j *jsiiProxy_DataOktaEmailCustomizations) TemplateNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"templateNameInput",
...
func (j *jsiiProxy_DataOktaEmailCustomizations) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataOktaEmailCustomizations) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataOktaEmailCustomizations) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/okta/okta/4.11.1/docs/data-sources/email_customizations okta_email_customizations} Data Source.
...
func (j *jsiiProxy_DataOktaEmailCustomizations)SetCount(val interface{}) {
...
// Experimental.
func DataOktaEmailCustomizations_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataOktaEmailCustomizations_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataOktaEmailCustomizations_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataOktaEmailCustomizations_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataOktaEmailCustomizations) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataOktaEmailCustomizations) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataOktaEmailCustomizations) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataOktaEmailCustomizations) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataOktaEmailCustomizations) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataOktaEmailCustomizations) ToMetadata() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataOktaEmailCustomizations) ToString() *string {
	var returns *string
...
func (d *jsiiProxy_DataOktaEmailCustomizations) ToTerraform() interface{} {
	var returns interface{}
