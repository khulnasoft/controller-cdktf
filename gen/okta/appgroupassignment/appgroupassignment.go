...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/okta/appgroupassignment/internal"
)
...
type jsiiProxy_AppGroupAssignment struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_AppGroupAssignment) AppId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"appId",
...
func (j *jsiiProxy_AppGroupAssignment) AppIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"appIdInput",
...
func (j *jsiiProxy_AppGroupAssignment) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_AppGroupAssignment) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_AppGroupAssignment) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AppGroupAssignment) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AppGroupAssignment) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_AppGroupAssignment) GroupId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"groupId",
...
func (j *jsiiProxy_AppGroupAssignment) GroupIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"groupIdInput",
...
func (j *jsiiProxy_AppGroupAssignment) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_AppGroupAssignment) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_AppGroupAssignment) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AppGroupAssignment) Node() constructs.Node {
...
func (j *jsiiProxy_AppGroupAssignment) Priority() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"priority",
...
func (j *jsiiProxy_AppGroupAssignment) PriorityInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"priorityInput",
...
func (j *jsiiProxy_AppGroupAssignment) Profile() *string {
	var returns *string
	_jsii_.Get(
		j,
		"profile",
...
func (j *jsiiProxy_AppGroupAssignment) ProfileInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"profileInput",
...
func (j *jsiiProxy_AppGroupAssignment) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_AppGroupAssignment) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_AppGroupAssignment) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewAppGroupAssignment(scope constructs.Construct, id *string, config *AppGroupAssignmentConfig) AppGroupAssignment {
	...
	if err := validateNewAppGroupAssignmentParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AppGroupAssignment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAppGroupAssignment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppGroupAssignment) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AppGroupAssignment) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppGroupAssignment) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_AppGroupAssignment) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_AppGroupAssignment) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_AppGroupAssignment) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_AppGroupAssignment) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_AppGroupAssignment) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_AppGroupAssignment) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_AppGroupAssignment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AppGroupAssignment) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppGroupAssignment) MoveFromId(id *string) {
...
func (a *jsiiProxy_AppGroupAssignment) MoveToId(id *string) {
...
func (a *jsiiProxy_AppGroupAssignment) OverrideLogicalId(newLogicalId *string) {
...
func (a *jsiiProxy_AppGroupAssignment) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_AppGroupAssignment) ResetPriority() {
	_jsii_.InvokeVoid(
		a,
		"resetPriority",
		nil, // no parameters
...
func (a *jsiiProxy_AppGroupAssignment) ResetProfile() {
	_jsii_.InvokeVoid(
		a,
		"resetProfile",
		nil, // no parameters
...
func (a *jsiiProxy_AppGroupAssignment) ResetRetainAssignment() {
	_jsii_.InvokeVoid(
		a,
		"resetRetainAssignment",
		nil, // no parameters
...
func (a *jsiiProxy_AppGroupAssignment) ToString() *string {
	var returns *string
