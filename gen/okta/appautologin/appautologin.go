...
// Represents a {@link https://registry.terraform.io/providers/okta/okta/4.11.1/docs/resources/app_auto_login okta_app_auto_login}.
...
func AppAutoLogin_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAppAutoLogin_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppAutoLogin) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AppAutoLogin) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AppAutoLogin) MoveFromId(id *string) {
...
func (a *jsiiProxy_AppAutoLogin) MoveToId(id *string) {
