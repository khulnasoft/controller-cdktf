...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/okta/authserverpolicy/internal"
)
...
func AuthServerPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAuthServerPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AuthServerPolicy) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AuthServerPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AuthServerPolicy) MoveFromId(id *string) {
...
func (a *jsiiProxy_AuthServerPolicy) MoveToId(id *string) {
