...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/okta/policyprofileenrollment/internal"
)
...
func (j *jsiiProxy_PolicyProfileEnrollment) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_PolicyProfileEnrollment)SetCount(val interface{}) {
...
func PolicyProfileEnrollment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validatePolicyProfileEnrollment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func PolicyProfileEnrollment_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validatePolicyProfileEnrollment_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func PolicyProfileEnrollment_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validatePolicyProfileEnrollment_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (p *jsiiProxy_PolicyProfileEnrollment) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PolicyProfileEnrollment) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_PolicyProfileEnrollment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_PolicyProfileEnrollment) MoveFromId(id *string) {
...
func (p *jsiiProxy_PolicyProfileEnrollment) MoveTo(moveTarget *string, index interface{}) {
...
func (p *jsiiProxy_PolicyProfileEnrollment) MoveToId(id *string) {
...
func (p *jsiiProxy_PolicyProfileEnrollment) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_PolicyProfileEnrollment) ToHclTerraform() interface{} {
	var returns interface{}
