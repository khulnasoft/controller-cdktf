...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/okta/dataoktatheme/internal"
)
...
func (j *jsiiProxy_DataOktaTheme) Count() interface{} {
...
// Create a new {@link https://registry.terraform.io/providers/okta/okta/4.11.1/docs/data-sources/theme okta_theme} Data Source.
...
func (j *jsiiProxy_DataOktaTheme)SetCount(val interface{}) {
...
func DataOktaTheme_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataOktaTheme_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func DataOktaTheme_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataOktaTheme_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataOktaTheme_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataOktaTheme_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataOktaTheme) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataOktaTheme) ToHclTerraform() interface{} {
	var returns interface{}
