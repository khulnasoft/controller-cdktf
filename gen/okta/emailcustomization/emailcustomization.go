...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/okta/emailcustomization/internal"
)

// Represents a {@link https://registry.terraform.io/providers/okta/okta/4.11.1/docs/resources/email_customization okta_email_customization}.
...
func EmailCustomization_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateEmailCustomization_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EmailCustomization) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EmailCustomization) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_EmailCustomization) MoveFromId(id *string) {
...
func (e *jsiiProxy_EmailCustomization) MoveToId(id *string) {
