...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/okta/captchaorgwidesettings/internal"
)
...
type CaptchaOrgWideSettings interface {
	...
	CaptchaId() *string
	SetCaptchaId(val *string)
	CaptchaIdInput() *string
	// Experimental.
	...
	EnabledFor() *[]*string
	SetEnabledFor(val *[]*string)
	EnabledForInput() *[]*string
	// Experimental.
...
type jsiiProxy_CaptchaOrgWideSettings struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_CaptchaOrgWideSettings) CaptchaId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"captchaId",
...
func (j *jsiiProxy_CaptchaOrgWideSettings) CaptchaIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"captchaIdInput",
...
func (j *jsiiProxy_CaptchaOrgWideSettings) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_CaptchaOrgWideSettings) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_CaptchaOrgWideSettings) EnabledFor() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"enabledFor",
...
func (j *jsiiProxy_CaptchaOrgWideSettings) EnabledForInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"enabledForInput",
...
func (j *jsiiProxy_CaptchaOrgWideSettings) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_CaptchaOrgWideSettings) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CaptchaOrgWideSettings) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_CaptchaOrgWideSettings) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_CaptchaOrgWideSettings) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_CaptchaOrgWideSettings) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CaptchaOrgWideSettings) Node() constructs.Node {
...
func (j *jsiiProxy_CaptchaOrgWideSettings) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_CaptchaOrgWideSettings) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_CaptchaOrgWideSettings) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func CaptchaOrgWideSettings_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCaptchaOrgWideSettings_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CaptchaOrgWideSettings) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CaptchaOrgWideSettings) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CaptchaOrgWideSettings) MoveFromId(id *string) {
...
func (c *jsiiProxy_CaptchaOrgWideSettings) MoveToId(id *string) {
...
func (c *jsiiProxy_CaptchaOrgWideSettings) ResetCaptchaId() {
	_jsii_.InvokeVoid(
		c,
		"resetCaptchaId",
		nil, // no parameters
...
func (c *jsiiProxy_CaptchaOrgWideSettings) ResetEnabledFor() {
	_jsii_.InvokeVoid(
		c,
		"resetEnabledFor",
		nil, // no parameters
...
func (c *jsiiProxy_CaptchaOrgWideSettings) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_CaptchaOrgWideSettings) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		c,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (c *jsiiProxy_CaptchaOrgWideSettings) ToString() *string {
	var returns *string
