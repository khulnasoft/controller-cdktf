...
// Represents a {@link https://registry.terraform.io/providers/okta/okta/4.11.1/docs/resources/app_saml okta_app_saml}.
...
func AppSaml_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateAppSaml_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppSaml) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AppSaml) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AppSaml) MoveFromId(id *string) {
...
func (a *jsiiProxy_AppSaml) MoveToId(id *string) {
...
func (a *jsiiProxy_AppSaml) ResetSamlSignedRequestEnabled() {
	_jsii_.InvokeVoid(
		a,
		"resetSamlSignedRequestEnabled",
		nil, // no parameters
