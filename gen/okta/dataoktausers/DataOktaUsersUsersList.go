...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/okta/dataoktausers/internal"
)

type DataOktaUsersUsersList interface {
	cdktf.ComplexList
...
// The jsii proxy struct for DataOktaUsersUsersList
type jsiiProxy_DataOktaUsersUsersList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_DataOktaUsersUsersList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_DataOktaUsersUsersList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataOktaUsersUsersList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataOktaUsersUsersList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_DataOktaUsersUsersList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (d *jsiiProxy_DataOktaUsersUsersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataOktaUsersUsersList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataOktaUsersUsersList) ToString() *string {
	var returns *string
