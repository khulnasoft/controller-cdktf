...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/okta/idpsaml/internal"
)
...
func (i *jsiiProxy_IdpSaml) MoveFromId(id *string) {
...
func (i *jsiiProxy_IdpSaml) MoveToId(id *string) {
