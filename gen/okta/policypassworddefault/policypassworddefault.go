...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/okta/policypassworddefault/internal"
)
...
func PolicyPasswordDefault_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validatePolicyPasswordDefault_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PolicyPasswordDefault) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PolicyPasswordDefault) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_PolicyPasswordDefault) MoveFromId(id *string) {
...
func (p *jsiiProxy_PolicyPasswordDefault) MoveToId(id *string) {
