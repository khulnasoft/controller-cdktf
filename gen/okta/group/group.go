...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/okta/group/internal"
)
...
func (j *jsiiProxy_Group) CustomProfileAttributes() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Group) CustomProfileAttributesInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (g *jsiiProxy_Group) ResetCustomProfileAttributes() {
	_jsii_.InvokeVoid(
		g,
		"resetCustomProfileAttributes",
		nil, // no parameters
