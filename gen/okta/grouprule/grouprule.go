...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/okta/grouprule/internal"
)

// Represents a {@link https://registry.terraform.io/providers/okta/okta/4.11.1/docs/resources/group_rule okta_group_rule}.
type GroupRule interface {
	...
	ExpressionTypeInput() *string
	ExpressionValue() *string
	SetExpressionValue(val *string)
	ExpressionValueInput() *string
	// Experimental.
	...
	SetGroupAssignments(val *[]*string)
	GroupAssignmentsInput() *[]*string
	Id() *string
	SetId(val *string)
	IdInput() *string
	// Experimental.
...
type jsiiProxy_GroupRule struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_GroupRule) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_GroupRule) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GroupRule) ExpressionType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"expressionType",
...
func (j *jsiiProxy_GroupRule) ExpressionTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"expressionTypeInput",
...
func (j *jsiiProxy_GroupRule) ExpressionValue() *string {
	var returns *string
	_jsii_.Get(
		j,
		"expressionValue",
...
func (j *jsiiProxy_GroupRule) ExpressionValueInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GroupRule) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GroupRule) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GroupRule) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GroupRule) GroupAssignments() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"groupAssignments",
...
func (j *jsiiProxy_GroupRule) GroupAssignmentsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"groupAssignmentsInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_GroupRule) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GroupRule) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GroupRule) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GroupRule) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GroupRule) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_GroupRule) Node() constructs.Node {
...
func (j *jsiiProxy_GroupRule) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_GroupRule) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_GroupRule) StatusInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"statusInput",
...
func (j *jsiiProxy_GroupRule) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GroupRule) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GroupRule) UsersExcluded() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"usersExcluded",
...
func (j *jsiiProxy_GroupRule) UsersExcludedInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"usersExcludedInput",
...
func NewGroupRule(scope constructs.Construct, id *string, config *GroupRuleConfig) GroupRule {
	...
	if err := validateNewGroupRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func GroupRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGroupRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GroupRule) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GroupRule) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GroupRule) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GroupRule) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GroupRule) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GroupRule) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GroupRule) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GroupRule) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GroupRule) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GroupRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GroupRule) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GroupRule) MoveFromId(id *string) {
...
func (g *jsiiProxy_GroupRule) MoveToId(id *string) {
...
func (g *jsiiProxy_GroupRule) OverrideLogicalId(newLogicalId *string) {
...
func (g *jsiiProxy_GroupRule) ResetExpressionType() {
	_jsii_.InvokeVoid(
		g,
		"resetExpressionType",
		nil, // no parameters
...
func (g *jsiiProxy_GroupRule) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GroupRule) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		g,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (g *jsiiProxy_GroupRule) ResetRemoveAssignedUsers() {
	_jsii_.InvokeVoid(
		g,
		"resetRemoveAssignedUsers",
		nil, // no parameters
...
func (g *jsiiProxy_GroupRule) ResetStatus() {
	_jsii_.InvokeVoid(
		g,
		"resetStatus",
		nil, // no parameters
...
func (g *jsiiProxy_GroupRule) ResetUsersExcluded() {
	_jsii_.InvokeVoid(
		g,
		"resetUsersExcluded",
		nil, // no parameters
...
func (g *jsiiProxy_GroupRule) ToString() *string {
	var returns *string
