...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/okta/emailsenderverification/internal"
)
...
// The jsii proxy struct for EmailSenderVerification
type jsiiProxy_EmailSenderVerification struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_EmailSenderVerification) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_EmailSenderVerification) Connection() interface{} {
...
func (j *jsiiProxy_EmailSenderVerification) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_EmailSenderVerification) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_EmailSenderVerification) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_EmailSenderVerification) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_EmailSenderVerification) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_EmailSenderVerification) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_EmailSenderVerification) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_EmailSenderVerification) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EmailSenderVerification) Node() constructs.Node {
...
func (j *jsiiProxy_EmailSenderVerification) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_EmailSenderVerification) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_EmailSenderVerification) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_EmailSenderVerification) SenderId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"senderId",
...
func (j *jsiiProxy_EmailSenderVerification) SenderIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"senderIdInput",
...
func (j *jsiiProxy_EmailSenderVerification) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_EmailSenderVerification) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EmailSenderVerification) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func EmailSenderVerification_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEmailSenderVerification_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func EmailSenderVerification_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateEmailSenderVerification_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func EmailSenderVerification_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateEmailSenderVerification_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (e *jsiiProxy_EmailSenderVerification) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EmailSenderVerification) HasResourceMove() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EmailSenderVerification) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_EmailSenderVerification) MoveFromId(id *string) {
...
func (e *jsiiProxy_EmailSenderVerification) MoveTo(moveTarget *string, index interface{}) {
...
func (e *jsiiProxy_EmailSenderVerification) MoveToId(id *string) {
...
func (e *jsiiProxy_EmailSenderVerification) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
...
func (e *jsiiProxy_EmailSenderVerification) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		e,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (e *jsiiProxy_EmailSenderVerification) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EmailSenderVerification) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EmailSenderVerification) ToHclTerraform() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EmailSenderVerification) ToMetadata() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EmailSenderVerification) ToString() *string {
	var returns *string
...
func (e *jsiiProxy_EmailSenderVerification) ToTerraform() interface{} {
	var returns interface{}
