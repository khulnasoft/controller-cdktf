...
type jsiiProxy_DataOktaUserSecurityQuestions struct {
	internal.Type__cdktfTerraformDataSource
}

func (j *jsiiProxy_DataOktaUserSecurityQuestions) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataOktaUserSecurityQuestions) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataOktaUserSecurityQuestions) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataOktaUserSecurityQuestions) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataOktaUserSecurityQuestions) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataOktaUserSecurityQuestions) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataOktaUserSecurityQuestions) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataOktaUserSecurityQuestions) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataOktaUserSecurityQuestions) Node() constructs.Node {
...
func (j *jsiiProxy_DataOktaUserSecurityQuestions) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataOktaUserSecurityQuestions) Questions() DataOktaUserSecurityQuestionsQuestionsList {
	var returns DataOktaUserSecurityQuestionsQuestionsList
	_jsii_.Get(
		j,
		"questions",
		&returns,
...
func (j *jsiiProxy_DataOktaUserSecurityQuestions) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataOktaUserSecurityQuestions) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataOktaUserSecurityQuestions) UserId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"userId",
...
func (j *jsiiProxy_DataOktaUserSecurityQuestions) UserIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"userIdInput",
...
func NewDataOktaUserSecurityQuestions(scope constructs.Construct, id *string, config *DataOktaUserSecurityQuestionsConfig) DataOktaUserSecurityQuestions {
	...
	if err := validateNewDataOktaUserSecurityQuestionsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataOktaUserSecurityQuestions_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataOktaUserSecurityQuestions_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataOktaUserSecurityQuestions) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataOktaUserSecurityQuestions) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataOktaUserSecurityQuestions) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataOktaUserSecurityQuestions) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataOktaUserSecurityQuestions) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataOktaUserSecurityQuestions) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataOktaUserSecurityQuestions) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataOktaUserSecurityQuestions) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataOktaUserSecurityQuestions) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataOktaUserSecurityQuestions) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataOktaUserSecurityQuestions) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataOktaUserSecurityQuestions) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataOktaUserSecurityQuestions) ToString() *string {
	var returns *string
