...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/okta/authserverclaimdefault/internal"
)
...
type jsiiProxy_AuthServerClaimDefault struct {
...
func (j *jsiiProxy_AuthServerClaimDefault) AuthServerId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"authServerId",
...
func (j *jsiiProxy_AuthServerClaimDefault) AuthServerIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"authServerIdInput",
...
func (j *jsiiProxy_AuthServerClaimDefault) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_AuthServerClaimDefault) ClaimType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"claimType",
...
func (j *jsiiProxy_AuthServerClaimDefault) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_AuthServerClaimDefault) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AuthServerClaimDefault) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AuthServerClaimDefault) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_AuthServerClaimDefault) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_AuthServerClaimDefault) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_AuthServerClaimDefault) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AuthServerClaimDefault) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_AuthServerClaimDefault) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_AuthServerClaimDefault) Node() constructs.Node {
...
func (j *jsiiProxy_AuthServerClaimDefault) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_AuthServerClaimDefault) Scopes() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"scopes",
...
func (j *jsiiProxy_AuthServerClaimDefault) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_AuthServerClaimDefault) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_AuthServerClaimDefault) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AuthServerClaimDefault) Value() *string {
	var returns *string
	_jsii_.Get(
		j,
		"value",
...
func (j *jsiiProxy_AuthServerClaimDefault) ValueInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"valueInput",
...
func (j *jsiiProxy_AuthServerClaimDefault) ValueType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"valueType",
...
func NewAuthServerClaimDefault(scope constructs.Construct, id *string, config *AuthServerClaimDefaultConfig) AuthServerClaimDefault {
	...
	if err := validateNewAuthServerClaimDefaultParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AuthServerClaimDefault_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAuthServerClaimDefault_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AuthServerClaimDefault) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AuthServerClaimDefault) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AuthServerClaimDefault) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_AuthServerClaimDefault) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_AuthServerClaimDefault) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_AuthServerClaimDefault) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_AuthServerClaimDefault) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_AuthServerClaimDefault) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_AuthServerClaimDefault) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_AuthServerClaimDefault) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AuthServerClaimDefault) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AuthServerClaimDefault) MoveFromId(id *string) {
...
func (a *jsiiProxy_AuthServerClaimDefault) MoveToId(id *string) {
...
func (a *jsiiProxy_AuthServerClaimDefault) OverrideLogicalId(newLogicalId *string) {
...
func (a *jsiiProxy_AuthServerClaimDefault) ResetAlwaysIncludeInToken() {
	_jsii_.InvokeVoid(
		a,
		"resetAlwaysIncludeInToken",
		nil, // no parameters
...
func (a *jsiiProxy_AuthServerClaimDefault) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_AuthServerClaimDefault) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_AuthServerClaimDefault) ResetValue() {
	_jsii_.InvokeVoid(
		a,
		"resetValue",
		nil, // no parameters
...
func (a *jsiiProxy_AuthServerClaimDefault) ToString() *string {
	var returns *string
