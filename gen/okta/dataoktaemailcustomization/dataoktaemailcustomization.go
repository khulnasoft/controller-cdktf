...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/okta/dataoktaemailcustomization/internal"
)
...
func DataOktaEmailCustomization_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateDataOktaEmailCustomization_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
