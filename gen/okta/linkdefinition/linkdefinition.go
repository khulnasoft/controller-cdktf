...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/okta/linkdefinition/internal"
)
...
func LinkDefinition_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLinkDefinition_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LinkDefinition) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LinkDefinition) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LinkDefinition) MoveFromId(id *string) {
...
func (l *jsiiProxy_LinkDefinition) MoveToId(id *string) {
