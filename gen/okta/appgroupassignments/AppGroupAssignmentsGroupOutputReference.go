...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/okta/appgroupassignments/internal"
)

type AppGroupAssignmentsGroupOutputReference interface {
	cdktf.ComplexObject
...
// The jsii proxy struct for AppGroupAssignmentsGroupOutputReference
type jsiiProxy_AppGroupAssignmentsGroupOutputReference struct {
	internal.Type__cdktfComplexObject
}

func (j *jsiiProxy_AppGroupAssignmentsGroupOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_AppGroupAssignmentsGroupOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AppGroupAssignmentsGroupOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AppGroupAssignmentsGroupOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AppGroupAssignmentsGroupOutputReference) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_AppGroupAssignmentsGroupOutputReference) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_AppGroupAssignmentsGroupOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_AppGroupAssignmentsGroupOutputReference) Priority() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"priority",
...
func (j *jsiiProxy_AppGroupAssignmentsGroupOutputReference) PriorityInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"priorityInput",
...
func (j *jsiiProxy_AppGroupAssignmentsGroupOutputReference) Profile() *string {
	var returns *string
	_jsii_.Get(
		j,
		"profile",
...
func (j *jsiiProxy_AppGroupAssignmentsGroupOutputReference) ProfileInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"profileInput",
...
func (j *jsiiProxy_AppGroupAssignmentsGroupOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_AppGroupAssignmentsGroupOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func (a *jsiiProxy_AppGroupAssignmentsGroupOutputReference) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AppGroupAssignmentsGroupOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (a *jsiiProxy_AppGroupAssignmentsGroupOutputReference) ResetPriority() {
	_jsii_.InvokeVoid(
		a,
		"resetPriority",
		nil, // no parameters
...
func (a *jsiiProxy_AppGroupAssignmentsGroupOutputReference) ResetProfile() {
	_jsii_.InvokeVoid(
		a,
		"resetProfile",
		nil, // no parameters
...
func (a *jsiiProxy_AppGroupAssignmentsGroupOutputReference) ToString() *string {
	var returns *string
