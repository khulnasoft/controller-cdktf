...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/okta/dataoktaeveryonegroup/internal"
)
...
type jsiiProxy_DataOktaEveryoneGroup struct {
	internal.Type__cdktfTerraformDataSource
}

func (j *jsiiProxy_DataOktaEveryoneGroup) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataOktaEveryoneGroup) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataOktaEveryoneGroup) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_DataOktaEveryoneGroup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataOktaEveryoneGroup) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataOktaEveryoneGroup) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataOktaEveryoneGroup) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataOktaEveryoneGroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataOktaEveryoneGroup) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataOktaEveryoneGroup) Node() constructs.Node {
...
func (j *jsiiProxy_DataOktaEveryoneGroup) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataOktaEveryoneGroup) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataOktaEveryoneGroup) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewDataOktaEveryoneGroup(scope constructs.Construct, id *string, config *DataOktaEveryoneGroupConfig) DataOktaEveryoneGroup {
	...
	if err := validateNewDataOktaEveryoneGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataOktaEveryoneGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataOktaEveryoneGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataOktaEveryoneGroup) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataOktaEveryoneGroup) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataOktaEveryoneGroup) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataOktaEveryoneGroup) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataOktaEveryoneGroup) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataOktaEveryoneGroup) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataOktaEveryoneGroup) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataOktaEveryoneGroup) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataOktaEveryoneGroup) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataOktaEveryoneGroup) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataOktaEveryoneGroup) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataOktaEveryoneGroup) ResetIncludeUsers() {
	_jsii_.InvokeVoid(
		d,
		"resetIncludeUsers",
		nil, // no parameters
...
func (d *jsiiProxy_DataOktaEveryoneGroup) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataOktaEveryoneGroup) ToString() *string {
	var returns *string
