...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/okta/dataoktaapp/internal"
)
...
type jsiiProxy_DataOktaApp struct {
...
func (j *jsiiProxy_DataOktaApp) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataOktaApp) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataOktaApp) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataOktaApp) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataOktaApp) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataOktaApp) Groups() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"groups",
...
func (j *jsiiProxy_DataOktaApp) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataOktaApp) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataOktaApp) Label() *string {
	var returns *string
	_jsii_.Get(
		j,
		"label",
...
func (j *jsiiProxy_DataOktaApp) LabelInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"labelInput",
...
func (j *jsiiProxy_DataOktaApp) LabelPrefix() *string {
	var returns *string
	_jsii_.Get(
		j,
		"labelPrefix",
...
func (j *jsiiProxy_DataOktaApp) LabelPrefixInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"labelPrefixInput",
...
func (j *jsiiProxy_DataOktaApp) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataOktaApp) Links() *string {
	var returns *string
	_jsii_.Get(
		j,
		"links",
...
func (j *jsiiProxy_DataOktaApp) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataOktaApp) Node() constructs.Node {
...
func (j *jsiiProxy_DataOktaApp) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataOktaApp) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_DataOktaApp) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataOktaApp) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataOktaApp) Users() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"users",
...
func NewDataOktaApp(scope constructs.Construct, id *string, config *DataOktaAppConfig) DataOktaApp {
	...
	if err := validateNewDataOktaAppParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataOktaApp_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataOktaApp_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataOktaApp) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataOktaApp) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataOktaApp) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataOktaApp) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataOktaApp) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataOktaApp) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataOktaApp) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataOktaApp) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataOktaApp) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataOktaApp) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataOktaApp) ResetActiveOnly() {
	_jsii_.InvokeVoid(
		d,
		"resetActiveOnly",
		nil, // no parameters
...
func (d *jsiiProxy_DataOktaApp) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataOktaApp) ResetLabel() {
	_jsii_.InvokeVoid(
		d,
		"resetLabel",
		nil, // no parameters
...
func (d *jsiiProxy_DataOktaApp) ResetLabelPrefix() {
	_jsii_.InvokeVoid(
		d,
		"resetLabelPrefix",
		nil, // no parameters
...
func (d *jsiiProxy_DataOktaApp) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataOktaApp) ResetSkipGroups() {
	_jsii_.InvokeVoid(
		d,
		"resetSkipGroups",
		nil, // no parameters
...
func (d *jsiiProxy_DataOktaApp) ResetSkipUsers() {
	_jsii_.InvokeVoid(
		d,
		"resetSkipUsers",
		nil, // no parameters
...
func (d *jsiiProxy_DataOktaApp) ToString() *string {
	var returns *string
