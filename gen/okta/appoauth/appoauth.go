...
// Represents a {@link https://registry.terraform.io/providers/okta/okta/4.11.1/docs/resources/app_oauth okta_app_oauth}.
...
func AppOauth_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateAppOauth_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppOauth) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AppOauth) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AppOauth) MoveFromId(id *string) {
...
func (a *jsiiProxy_AppOauth) MoveToId(id *string) {
