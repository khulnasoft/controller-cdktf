...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/okta/dataoktaappgroupassignments/internal"
)
...
func DataOktaAppGroupAssignments_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataOktaAppGroupAssignments_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
