...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/okta/userbaseschemaproperty/internal"
)
...
type jsiiProxy_UserBaseSchemaProperty struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_UserBaseSchemaProperty) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_UserBaseSchemaProperty) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_UserBaseSchemaProperty) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_UserBaseSchemaProperty) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_UserBaseSchemaProperty) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_UserBaseSchemaProperty) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_UserBaseSchemaProperty) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_UserBaseSchemaProperty) Index() *string {
	var returns *string
	_jsii_.Get(
		j,
		"index",
...
func (j *jsiiProxy_UserBaseSchemaProperty) IndexInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"indexInput",
...
func (j *jsiiProxy_UserBaseSchemaProperty) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_UserBaseSchemaProperty) Master() *string {
	var returns *string
	_jsii_.Get(
		j,
		"master",
...
func (j *jsiiProxy_UserBaseSchemaProperty) MasterInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"masterInput",
...
func (j *jsiiProxy_UserBaseSchemaProperty) Node() constructs.Node {
...
func (j *jsiiProxy_UserBaseSchemaProperty) Pattern() *string {
	var returns *string
	_jsii_.Get(
		j,
		"pattern",
...
func (j *jsiiProxy_UserBaseSchemaProperty) PatternInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"patternInput",
...
func (j *jsiiProxy_UserBaseSchemaProperty) Permissions() *string {
	var returns *string
	_jsii_.Get(
		j,
		"permissions",
...
func (j *jsiiProxy_UserBaseSchemaProperty) PermissionsInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"permissionsInput",
...
func (j *jsiiProxy_UserBaseSchemaProperty) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_UserBaseSchemaProperty) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_UserBaseSchemaProperty) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_UserBaseSchemaProperty) Title() *string {
	var returns *string
	_jsii_.Get(
		j,
		"title",
...
func (j *jsiiProxy_UserBaseSchemaProperty) TitleInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"titleInput",
...
func (j *jsiiProxy_UserBaseSchemaProperty) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_UserBaseSchemaProperty) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
func (j *jsiiProxy_UserBaseSchemaProperty) UserType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"userType",
...
func (j *jsiiProxy_UserBaseSchemaProperty) UserTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"userTypeInput",
...
func NewUserBaseSchemaProperty(scope constructs.Construct, id *string, config *UserBaseSchemaPropertyConfig) UserBaseSchemaProperty {
	...
	if err := validateNewUserBaseSchemaPropertyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func UserBaseSchemaProperty_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateUserBaseSchemaProperty_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (u *jsiiProxy_UserBaseSchemaProperty) AddMoveTarget(moveTarget *string) {
...
func (u *jsiiProxy_UserBaseSchemaProperty) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (u *jsiiProxy_UserBaseSchemaProperty) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (u *jsiiProxy_UserBaseSchemaProperty) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (u *jsiiProxy_UserBaseSchemaProperty) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (u *jsiiProxy_UserBaseSchemaProperty) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (u *jsiiProxy_UserBaseSchemaProperty) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (u *jsiiProxy_UserBaseSchemaProperty) GetStringAttribute(terraformAttribute *string) *string {
...
func (u *jsiiProxy_UserBaseSchemaProperty) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (u *jsiiProxy_UserBaseSchemaProperty) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (u *jsiiProxy_UserBaseSchemaProperty) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (u *jsiiProxy_UserBaseSchemaProperty) MoveFromId(id *string) {
...
func (u *jsiiProxy_UserBaseSchemaProperty) MoveToId(id *string) {
...
func (u *jsiiProxy_UserBaseSchemaProperty) OverrideLogicalId(newLogicalId *string) {
...
func (u *jsiiProxy_UserBaseSchemaProperty) ResetId() {
	_jsii_.InvokeVoid(
		u,
		"resetId",
		nil, // no parameters
...
func (u *jsiiProxy_UserBaseSchemaProperty) ResetMaster() {
	_jsii_.InvokeVoid(
		u,
		"resetMaster",
		nil, // no parameters
...
func (u *jsiiProxy_UserBaseSchemaProperty) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		u,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (u *jsiiProxy_UserBaseSchemaProperty) ResetPattern() {
	_jsii_.InvokeVoid(
		u,
		"resetPattern",
		nil, // no parameters
...
func (u *jsiiProxy_UserBaseSchemaProperty) ResetPermissions() {
	_jsii_.InvokeVoid(
		u,
		"resetPermissions",
		nil, // no parameters
...
func (u *jsiiProxy_UserBaseSchemaProperty) ResetRequired() {
	_jsii_.InvokeVoid(
		u,
		"resetRequired",
		nil, // no parameters
...
func (u *jsiiProxy_UserBaseSchemaProperty) ResetUserType() {
	_jsii_.InvokeVoid(
		u,
		"resetUserType",
		nil, // no parameters
...
func (u *jsiiProxy_UserBaseSchemaProperty) ToString() *string {
	var returns *string
