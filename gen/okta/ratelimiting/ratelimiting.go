...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/okta/ratelimiting/internal"
)

// Represents a {@link https://registry.terraform.io/providers/okta/okta/4.11.1/docs/resources/rate_limiting okta_rate_limiting}.
...
func RateLimiting_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRateLimiting_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RateLimiting) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RateLimiting) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (r *jsiiProxy_RateLimiting) MoveFromId(id *string) {
...
func (r *jsiiProxy_RateLimiting) MoveToId(id *string) {
