...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/okta/appsignonpolicy/internal"
)
...
func AppSignonPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAppSignonPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppSignonPolicy) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AppSignonPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AppSignonPolicy) MoveFromId(id *string) {
...
func (a *jsiiProxy_AppSignonPolicy) MoveToId(id *string) {
