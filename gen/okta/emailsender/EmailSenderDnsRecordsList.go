...
type EmailSenderDnsRecordsList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) EmailSenderDnsRecordsOutputReference
...
// The jsii proxy struct for EmailSenderDnsRecordsList
type jsiiProxy_EmailSenderDnsRecordsList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_EmailSenderDnsRecordsList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_EmailSenderDnsRecordsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_EmailSenderDnsRecordsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_EmailSenderDnsRecordsList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_EmailSenderDnsRecordsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (e *jsiiProxy_EmailSenderDnsRecordsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EmailSenderDnsRecordsList) ComputeFqn() *string {
	var returns *string
...
func (e *jsiiProxy_EmailSenderDnsRecordsList) ToString() *string {
	var returns *string
