...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/okta/appsignonpolicyrule/internal"
)
...
func AppSignonPolicyRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AppSignonPolicyRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
