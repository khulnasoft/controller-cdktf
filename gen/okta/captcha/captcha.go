...
import (
	...
	"github.com/khulnasoft/controller-cdktf/gen/okta/captcha/internal"
)
...
type jsiiProxy_Captcha struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_Captcha) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_Captcha) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_Captcha) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Captcha) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Captcha) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_Captcha) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_Captcha) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_Captcha) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Captcha) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_Captcha) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_Captcha) Node() constructs.Node {
...
func (j *jsiiProxy_Captcha) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_Captcha) SecretKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"secretKey",
...
func (j *jsiiProxy_Captcha) SecretKeyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"secretKeyInput",
...
func (j *jsiiProxy_Captcha) SiteKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"siteKey",
...
func (j *jsiiProxy_Captcha) SiteKeyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"siteKeyInput",
...
func (j *jsiiProxy_Captcha) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Captcha) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Captcha) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_Captcha) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
func NewCaptcha(scope constructs.Construct, id *string, config *CaptchaConfig) Captcha {
	...
	if err := validateNewCaptchaParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_Captcha{}
...
func Captcha_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCaptcha_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_Captcha) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_Captcha) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_Captcha) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (c *jsiiProxy_Captcha) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (c *jsiiProxy_Captcha) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (c *jsiiProxy_Captcha) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (c *jsiiProxy_Captcha) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (c *jsiiProxy_Captcha) GetStringAttribute(terraformAttribute *string) *string {
...
func (c *jsiiProxy_Captcha) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (c *jsiiProxy_Captcha) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_Captcha) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_Captcha) MoveFromId(id *string) {
...
func (c *jsiiProxy_Captcha) MoveToId(id *string) {
...
func (c *jsiiProxy_Captcha) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_Captcha) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_Captcha) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		c,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (c *jsiiProxy_Captcha) ToString() *string {
	var returns *string
